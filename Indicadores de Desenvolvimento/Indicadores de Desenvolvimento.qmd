---
title: "Indicadores de Desenvolvimento"
...
## Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022

```{r fig-idcras-niveis, fig.cap = "Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022:"}
#| fig-height: 20

tabela <- f_quantitativo_regiao_niveis(idcras_2022, `Estrutura Física`, IBGE7, "Estrutura Física") %>%
  bind_rows(f_quantitativo_regiao_niveis(idcras_2022, `Recursos Humanos`, IBGE7, "Recursos Humanos")) %>%
  bind_rows(f_quantitativo_regiao_niveis(idcras_2022, `Serviços `, IBGE7, "Serviços & Benefícios")) %>%
...
```{r fig-idcras-niveis-2, fig.cap = "Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcras-niveis-3, fig.cap = "Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcras-niveis-4, fig.cap = "Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcras-niveis-5, fig.cap = "Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcras-niveis-6, fig.cap = "Indicador de Desenvolvimento do CRAS, quantitativo de CRAS em cada nível, 2022:"}
#| fig-height: 20
...
## Indicador de Desenvolvimento do CRAS, percentuais de CRAS em cada nível, 2022

```{r fig-idcras-percentual, fig.cap = "Indicador de Desenvolvimento do CRAS, percentuais de CRAS em cada nível, 2022"}

tabela <-
            f_percentual_regiao_niveis(idcras_2022, `Estrutura Física`, IBGE7, "Estrutura Física") %>%
  bind_rows(f_percentual_regiao_niveis(idcras_2022, `Recursos Humanos`, IBGE7, "Recursos Humanos")) %>%
  bind_rows(f_percentual_regiao_niveis(idcras_2022, `Serviços `, IBGE7, "Serviços & Benefícios")) %>%
...
```{r fig-idcras-percentual-1, fig.cap = "Indicador de Desenvolvimento do CRAS, percentuais de CRAS em cada nível, 2022"}
...
## Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022

```{r fig-idcreas-niveis, fig.cap = "Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022:"}
#| fig-height: 20

tabela <- f_quantitativo_regiao_niveis(idcreas_2022, `Estrutura Física`, `Código IBGE`, "Estrutura Física") %>%
  bind_rows(f_quantitativo_regiao_niveis(idcreas_2022, `Recursos Humanos`, `Código IBGE`, "Recursos Humanos")) %>%
  bind_rows(f_quantitativo_regiao_niveis(idcreas_2022, `Serviços `, `Código IBGE`, "Serviços & Benefícios")) %>%
...
```{r fig-idcreas-niveis-2, fig.cap = "Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcreas-niveis-3, fig.cap = "Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcreas-niveis-4, fig.cap = "Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcreas-niveis-5, fig.cap = "Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idcreas-niveis-6, fig.cap = "Indicador de Desenvolvimento do CREAS, quantitativo de CREAS em cada nível, 2022:"}
#| fig-height: 20
...
## Indicador de Desenvolvimento do CREAS, percentuais de CREAS em cada nível, 2022

```{r fig-idcreas-percentual, fig.cap = "Indicador de Desenvolvimento do CREAS, percentuais de CREAS em cada nível, 2022"}

tabela <-
            f_percentual_regiao_niveis(idcreas_2022, `Estrutura Física`, `Código IBGE`, "Estrutura Física") %>%
  bind_rows(f_percentual_regiao_niveis(idcreas_2022, `Recursos Humanos`, `Código IBGE`, "Recursos Humanos")) %>%
  bind_rows(f_percentual_regiao_niveis(idcreas_2022, `Serviços `, `Código IBGE`, "Serviços & Benefícios")) %>%
...
```{r fig-idcreas-percentual-1, fig.cap = "Indicador de Desenvolvimento do CREAS, percentuais de CREAS em cada nível, 2022"}
...
## Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022

```{r fig-idconselho-niveis, fig.cap = "Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022:"}
#| fig-height: 20

tabela <- f_quantitativo_regiao_niveis(idconselho_2022, `Estrutura Administrativa`, IBGE, "Estrutura Administrativa") %>%
  bind_rows(f_quantitativo_regiao_niveis(idconselho_2022, `Dinâmica de Funcionamento`, IBGE, "Dinâmica de Funcionamento")) %>%
  bind_rows(f_quantitativo_regiao_niveis(idconselho_2022, `Composição do Conselho`, IBGE, "Composição do Conselho")) %>%
...
```{r fig-idconselho-niveis-2, fig.cap = "Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idconselho-niveis-3, fig.cap = "Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idconselho-niveis-4, fig.cap = "Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idconselho-niveis-5, fig.cap = "Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022:"}
#| fig-height: 20
...
```{r fig-idconselho-niveis-6, fig.cap = "Indicador de Desenvolvimento dos Conselhos, quantitativo de Conselhos em cada nível, 2022:"}
#| fig-height: 20
...
## Indicador de Desenvolvimento dos Conselhos, percentuais de Conselhos em cada nível, 2022

```{r fig-idconselho-percentual, fig.cap = "Indicador de Desenvolvimento dos Conselhos, percentuais de Conselhos em cada nível, 2022"}

tabela <-
            f_percentual_regiao_niveis(idconselho_2022, `Estrutura Administrativa`, IBGE, "Estrutura Administrativa") %>%
  bind_rows(f_percentual_regiao_niveis(idconselho_2022, `Dinâmica de Funcionamento`, IBGE, "Dinâmica de Funcionamento")) %>%
  bind_rows(f_percentual_regiao_niveis(idconselho_2022, `Composição do Conselho`, IBGE, "Composição do Conselho")) %>%
...
```{r fig-idconselho-percentual-1, fig.cap = "Indicador de Desenvolvimento dos Conselhos, percentuais de Conselhos em cada nível, 2022"}
