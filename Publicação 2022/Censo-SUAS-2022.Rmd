...
cras_2022 <- read_excel("../Censo SUAS 2022/1_CRAS/Censo_SUAS_2022_CRAS_Dados_Gerais_Divulgação.xlsx", sheet = "Sheet1")
...
#cedia_2022 <- read_excel("../Censo SUAS 2022/6 - CENTRO DIA/Censo_SUAS_2022_Centro_Dia_dados_gerais.xlsx", sheet = "")
...
```{r estados-caracteristica-secretaria, fig.cap = "Percentual de estados segundo característica da Secretaria estadual de Assistência Social - Brasil, 2017", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r estados-constituicao-subdivisoes, fig.cap = "Distribuição dos órgãos gestores estaduais segundo constituição/formalização de subdivisões administrativas - Brasil, 2017", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r eval=FALSE, fig.cap = "Evolução dos CRAS segundo situação do imóvel – Brasil, 2007 - 2012 - 2017 - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}

f_cras_imovel = function(df, q, ano){
  q <- enquo(q)
  ano <- quo_name(ano)
...
grafico <- f_cras_imovel(cras_2007, v15, "2007") %>%
  ...
  bind_rows(f_cras_imovel(cras_2022, q3, "2022")) %>%
...
```{r CRAS-internet-quantitativo, fig.cap = "Evolução do quantitativo de CRAS com computadores com acesso à internet – Brasil, 2007 a 2017", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r CRAS-SCFV, fig.cap = "Percentual de CRAS que executavam diretamente os Serviços de Convivência e Fortalecimento de Vínculos - Brasil, 2010 a 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r centro-conv-natureza, fig.cap = "Quantitativo de Centros de Convivência por Natureza da Unidade - BRASIL, 2014 - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r CREAS-municipios_1, fig.cap = "Evolução de CREAS por número de municípios, 2012 - 2017 - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#tabela <- equip_acessibilidade(unac_2012, q35_1, "2012", "1") %>%
#  bind_rows(equip_acessibilidade(unac_2012, q35_2, "2012", "2")) %>% 
#  bind_rows(equip_acessibilidade(unac_2012, q35_3, "2012", "3")) %>% 
#  bind_rows(equip_acessibilidade(unac_2012, q35_4, "2012", "4")) %>% 
tabela <- equip_acessibilidade(unac_2017, q37.1, "2017", "1") %>%
