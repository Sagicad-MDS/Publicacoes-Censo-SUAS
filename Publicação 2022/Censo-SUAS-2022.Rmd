...
```{r estados_sec_exc, fig.cap = "Percentual de Estados quanto a característica de estrutura administrativa, 2012 a 2022 - Brasil", fig.footer = "Fonte: MDS, Censo SUAS"}
...
O cadastramento domiciliar permite uma aproximação com aspectos do cotidiano das famílias, visto que a coleta das informações ocorre por meio do encontro da gestão até as famílias. Essa ação objetiva assegurar o acesso a inclusão ou atualização cadastral na residência das pessoas. De acordo com informações do \cref{fig:visit_dom} as situações mais frequentes para visita domiciliar são para averiguação cadastral e inclusão/atualização de dados do BPC (Benefício de Prestação Continuada - BPC).
...
Trata-se de um recurso repassado aos estados e municípios para apoio a gestão do Cadastro Único e Bolsa Família. Esta informação é referente as respostas do formulário dos postos de cadastramento em âmbito dos municípios.
...
Os dados de CRAS que funcionam com imóvel próprio evoluiram significativamente de 2008 a 2022. Destaca-se que o primeiro ano da série histórica possuia 43,7% CRAS com imóvel próprio (\Cref{fig:CRAS-imovel}), dado que chega em 2022 com 59,62%. Dados com CRAS que funcionam com imóveis alugados passam por redução de 48,2% para 32,2%.
...
De acordo com os dados do \cref{fig:CREAS-porte} no qual sinaliza o número de CREAS por município, levando-se em conta o porte populacional, verifica-se que 54% dos municípios não possuem CREAS. E eles estão concentrados nos municípios de Pequeno Porte I e II respectivamente com 77% e 5,3% dos municípios que não possuem esta unidade especializada.
...
A presença de acesso principal adaptado com rota acessível aos espaços (recepção, salas de atendimento e espaços de uso coletivo) é a mais presente nas unidades de CREAS com destaque para 83% no CENSO SUAS  de 2022.

O \cref{fig:creas-acessibilidade} referencia outras adaptações como com rampas, rota acessível e calçada e de rota acessível ao banheiro. Todas essas adaquações ampliaram a acessibildiade ao longo dos anos.
...
A oferta regionalizada de CREAS é uma estratégia que objetiva garantir a universalização do acesso e integralidade do antendimento da proteção socioassistencial especializada. Está prevista na Resolução 31/2013 do CNAS. Essa composição é organizada através dos entes estaduais e o \cref{fig:creas-regionais} sinaliza a evolução dessa oferta.
...
Em 2016, 95% dos Centros Pop destacam computador com acesso à internet em 2022. O \cref{fig:cpop-internet-percentual} referencia essa evolução por Regiões do Brasil, as regiões Centro-Oeste e Sul possuem 100% das unidades com acesso à internet e a região Norte com maior desafio de acesso, com 75% das unidades de Centro Pop com acesso à internet.
...
Em relação a natureza destas unidades, o \cref{fig:cdia-natureza} sinaliza a frequência histórica de unidades referenciadas pelas Organizações da Sociedade Civil (OSCs). Das unidades destacadas no Censo SUAS 2022, 92,8% são ofertadas por OSCs.
...
Em relação a acessibilidade destas unidades, o banheiro acessivel é a adaptação mais presente nestas unidades chegando nos registros do Censo SUAS de 2022 com 73%. Como trata-se de unidades especializadas para atenção a pessoas com deficiência, esse item é de fundamental importância para assegurar acolhida e segurança a este público e suas famílias. O \cref{fig:cdia-acessibilidade} sinaliza os locais e composição de acessibilidade, estes dados sinalizam um desafio para garantir as condições físicas de acesso ao público de pessoas com deficiência nas unidades de Centro Dia.
...
Além disto, há outras adaptações importantes netsas undiades, dentre elas as tecnologias assistidas, suportes com materiais em braille, profissionais com conhecimento em libras entre outros destacados no gráfico abaixo:
...
if(gera.graficos.office) grafico %>% graph2office(file="graficos", append = TRUE)
```
Em relação ao acesso à internet, observa-se uma evolução nos últimos 10 anos. Em 2012 62,2% das unidades possuem acesso à internet, o censo suas de 2022 destaca que 100% dos computadores das unidades possuem acesso à internet conforme o \cref{fig:unac-internet}.
...
Busca garantir acesso a  direitossociais a quem necessitam. A centralidade na família é \Cref{fig:quantitativo-CRAS}
...
O PAIF é serviço tipificado na qual tem a finalidade de fortalecer a função protetiva das famílias, prevenir a ruptura  dos seus vínculos, promover seu acesso e usufruto de direitos e contribuir na melhoria de sua qualidade de vida \footnote{Resolução CNAS Nº 109/2009 - Tipificação dos Serviços Socioassistenciais}. Esse serviço é ofertado através das unidades de CRAS destacadas acima


Os Serviços da Proteção Social Básica  devem ser referenciados e articulação com PAIF.
