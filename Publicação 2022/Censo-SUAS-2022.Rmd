...
ge_2018 <- read_excel("../Censo SUAS 2018/9.GestÆo Estadual/Censo_SUAS_2018_Gestão_Estadual_Dados_Gerais_divulgaçao.xlsx", sheet = 1)

gerh_2018 <- read_excel("../Censo SUAS 2018/9.GestÆo Estadual/Censo_SUAS_2018_Gestão_Estadual_RH_divulgação.xlsx", sheet = 1)

ge_2019 <- read_excel("../Censo SUAS 2019/GestÆo Estadual/Censo_SUAS_2019_dados_gerais_GE__divulgação.xlsx", sheet = 1)

#gerh_2019 <- read_excel("../", sheet = 1)

ge_2020 <- read_excel("../Censo SUAS 2020/10_GESTAO_ESTADUAL/Censo_SUAS_2020_dados_gerais_Gestão_Estadual.xlsx", sheet = 1)

gerh_2020 <- read_excel("../Censo SUAS 2020/10_GESTAO_ESTADUAL/Censo_SUAS_2020_RH_Gestão_Estadual.xlsx", sheet = 1)
...
posto_cadunico_2020 <- read_excel("../Censo SUAS 2020/8_POSTO_CADASTRAMENTO/Censo_SUAS_2020_Postos_Cadastro_Único_Dados_Gerais.xlsx", sheet = 1)

posto_cadunicorh_2020 <- read_excel("../Censo SUAS 2020/8_POSTO_CADASTRAMENTO/Censo_SUAS_2020_Postos_Cadastro_Único_RH.xlsx", sheet = 1)
...
creas_2020 <- read_excel("../Censo SUAS 2020/CREAS/Censo_SUAS_CREAS_2020_Dados_Gerais_divulgacao_revisado.xlsx", sheet = 1)

#creasrh_2020 <- read_excel("../Censo SUAS 2020/CREAS/Censo_SUAS_CREAS_2020_RH_divulgacao.xlsx", sheet = 1)
...
cmun_2020 <- read_excel("../Censo SUAS 2020/Conselho Municipal/Censo_SUAS_2020_Conselho_municipal_Dados_Gerais.xlsx", sheet = 1)

cmunrh_2020 <- read_excel("../Censo SUAS 2020/Conselho Municipal/Censo_SUAS_2020_Conselho_municipal_RH.xlsx", sheet = 1)
...
cmun_2022 <- read_excel("../Censo SUAS 2022/13 - CONSELHO MUNICIPAL/Censo_SUAS_2022_Conselho_Municipal_Dados_gerais.xlsx", sheet = 1)

cmunrh_2022 <- read_excel("../Censo SUAS 2022/13 - CONSELHO MUNICIPAL/Censo_SUAS_2022_Conselho_Municipal_RH.xlsx", sheet = 1)
...
cpop_2020 <- read_excel("../Censo SUAS 2020/3_CENTRO_POP/CensoSUAS_2020_Dados_Gerais_Centro_POP.xlsx", sheet = 1)

cpoprh_2020 <- read_excel("../Censo SUAS 2020/3_CENTRO_POP/CensoSUAS_2020_RH_Centro_POP.xlsx", sheet = 1)
...
unac_2020 <- read_excel("../Censo SUAS 2020/Unidade_de_Acolhimento/Censo_SUAS_2020_DG_Acolhimento.xlsx", sheet = 1)

unacrh_2020 <- read_excel("../Censo SUAS 2020/Unidade_de_Acolhimento/Censo_SUAS_2020_RH_Acolhimento.xlsx", sheet = 1)
...
ceconv_2020 <- read_excel("../Censo SUAS 2020/5_CENTRO_CONVIVENCIA/Censo_SUAS_2020_Centro_Convivencia_dados_gerais.xlsx", sheet = 1)

ceconvrh_2020 <- read_excel("../Censo SUAS 2020/5_CENTRO_CONVIVENCIA/Censo_SUAS_2020_Centro_Convivencia_RH.xlsx", sheet = 1)
...
cedia_2020 <- read_excel("../Censo SUAS 2020/6_CENTRO_DIA/Censo_SUAS_2020_Centro_Dia_Dados_Gerais.xls", sheet = 1)

cediarh_2020 <- read_excel("../Censo SUAS 2020/6_CENTRO_DIA/Censo_SUAS_2020_Centro_Dia_RH.xlsx", sheet = 1)
...
Em relação a atendimento Povos e comunidades Tradicionais, em 2018, 31% dos CRAS informaram que possuem povos e comunidades tradicionais em seu território de abrangência. Esse dado avança em relação ao ano de 2012\footnote{a partir de 2019 a pergunta foi alterada}.
...
<!-- não consegui identificar erro que gerou NA -->
...
```{r paefi2_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações de riscos em decorrencia trabalho analogo a escravidão e trabalho infantil - Brasil  2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#2022
  categoria <- case_when(!! cod_categoria == "1"~"Trabalho em condição análoga à escravidão - Criança e Adolescente",
                         ...
                         !! cod_categoria == "5"~"Trabalho em condição análoga à escravidão - não atende esse tipo de situação",
 ...
 tabela <- paefi2_creas (creas_2022,q16_8_1,"2022","1") %>%
  ...
  bind_rows(paefi2_creas(creas_2022,q16_8_0,"2022","5")) %>%
...
```{r paefi3_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações de rua - Brasil  2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r paefi4_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações de rua - Brasil  2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r paefi5_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações violência/violação de direitos por Pessoas com Deficiência - Brasil  2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
\footnote{Série só possível de ser selecionada historicametne a partir de 2018}
