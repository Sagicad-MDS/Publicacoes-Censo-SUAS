...
grafico <- be_uf_renda(ge_2012, q33, "2012") %>%
   bind_rows(be_uf_renda(ge_2013, q43, "2013")) %>% 
   bind_rows(be_uf_renda(ge_2014, q74, "2014")) %>% 
   bind_rows(be_uf_renda(ge_2015, q61, "2015")) %>% 
   bind_rows(be_uf_renda(ge_2016, q24, "2016")) %>% 
   bind_rows(be_uf_renda(ge_2017, q27, "2017")) %>%
   bind_rows(be_uf_renda(ge_2018, q_11,"2018")) %>%
   bind_rows(be_uf_renda(ge_2019, q11, "2019")) %>%
   bind_rows(be_uf_renda(ge_2020, q10, "2020")) %>%
   bind_rows(be_uf_renda(ge_2021, q10, "2021")) %>%
   bind_rows(be_uf_renda(ge_2022, q10, "2022")) %>%
...
grafico <- be_uf_renda(ge_2012, q33, "2012") %>%
   ...
   #bind_rows(be_uf_renda(ge_2020, q10, "2020")) %>%
   #bind_rows(be_uf_renda(ge_2021, q10, "2021")) %>%
   bind_rows(be_uf_renda(ge_2022, q11_1, "2022")) %>%
  
  #em sistematização (2012 é outra pergunta, apenas 2022 estar correta)
...
Essa seção apresenta informações sobre as unidades físicas do SUAS e sua evolução ao longo do tempo. Esse item contempla as seguintes informações: a) quantidade de unidades administrativas de CRAS, CREAS, Centro Dia, Centro Pop ...
b) informações sobre acessibilidade, c) situação do imovél, d) disponibilidade de equipamentos como computador com acesso a internet.
...
<!-- o grafico gerou NA, não consegui identificar o verificar o erro -->
...
dispõe deste equipamento público.
...
Ao observar o número de CRAS por municípios, levando-se em conta o porte populacional, verifica-se que os 35 municípios do país que não possuem CRAS estão concentrados em municípios de pequeno porte \Cref{fig:CRAS-porte}. Em relação a localização, destaca-se que 77% deles localizados na Região Sul, 20% na Região Sudeste e 3% na região Nordeste.
