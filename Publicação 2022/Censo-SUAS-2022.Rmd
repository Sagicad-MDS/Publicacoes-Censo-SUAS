...
grafico <- be_uf_renda(ge_2020, q11_1, "2020") %>%
   bind_rows(be_uf_renda(ge_2021, q11_1, "2021")) %>%
...
<!-- SERÁ QUE CONSEGUIMOS COLOCAR OS EM BRANCO? OU COLOCAR EM QUANTIDADE?}). -->


```{r povos-tradicionais_cad_cras, fig.cap = "Percentual de atendimentos do Cadastro Único de públicos GPTE nos CRAS - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}


CadunicoGPTE_cras= function(df, q, ano, cod_categoria){
  q <- enquo(q)
  ano <- quo_name(ano)
  cod_categoria <- quo_name(cod_categoria)
...
#2020
 ...
 tabela <- CadunicoGPTE_cras (cras_2022,q65_1_3,"2022","1") %>% 
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_2_1,"2020","2")) %>% 
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_3_1,"2020","3")) %>% 
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_4_1,"2020","4")) %>% 
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_5_1,"2020","5")) %>%
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_6_1,"2020","6")) %>% 
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_7_1,"2020","7")) %>%
#bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_8_1,"2020","8")) %>% 
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2020,q21_9_1,"2020","9")) %>%
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_1_1,"2021","1")) %>%
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_2_1,"2021","2")) %>% 
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_3_1,"2021","3")) %>% 
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_4_1,"2021","4")) %>% 
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_5_1,"2021","5")) %>%
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_6_1,"2021","6")) %>% 
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_7_1,"2021","7")) %>%
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_8_1,"2021","8")) %>% 
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2021,q21_9_1,"2021","9")) %>%
  #bind_rows(CadunicoGPTE_cras(posto_cadunico_2022,q21_1_1,"2022","1")) %>%
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_2_3,"2022","2")) %>% 
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_3_3,"2022","3")) %>% 
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_4_3,"2022","4")) %>% 
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_5_3,"2022","5")) %>%
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_6_3,"2022","6")) %>% 
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_7_3,"2022","7")) %>%
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_8_3,"2022","8")) %>% 
  bind_rows(CadunicoGPTE_cras(cras_2022,q65_9_3,"2022","9")) %>%
...
```{r CREAS-municipios, fig.cap = "Percentual de CREAS por região, segundo grandes regiões - 2012, 2017 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
dados <- unac_municipios %>%
  full_join(porte_municipios, by = c("IBGE7" = "IBGE7")) %>%
  mutate(grupo = case_when(is.na(n_unac)~"Nenhum UNIDADE ACOLHIMENTO",
                            n_unac == 0~"Nenhum UNIDADE ACOLHIMENTO",
                            n_unac == 1~"1 UNIDADE ACOLHIMENTO",
                            n_unac <= 3~"De 2 a 3 UNIDADE ACOLHIMENTO",
                            n_unac <= 6~"De 4 a 6 UNIDADE ACOLHIMENTO",
                            n_unac <= 10~"De 7 a 10 UNIDADE ACOLHIMENTO",
                            n_unac > 10~"Mais de 10 UNIDADE ACOLHIMENTO",
                            TRUE~as.character(n_unac))) %>%
  mutate(grupo = factor(grupo, levels = c("Nenhum UNIDADE ACOLHIMENTO",
                                            "1 UNIDADE ACOLHIMENTO",
                                            "De 2 a 3 UNIDADE ACOLHIMENTO",
                                            "De 4 a 6 UNIDADE ACOLHIMENTO",
                                            "De 7 a 10 UNIDADE ACOLHIMENTO",
                                            "Mais de 10 UNIDADE ACOLHIMENTO"))) %>% 
  group_by(Porte, grupo) %>%
  summarise(n=n()) #%>%
#  complete(grupo, fill = list(n=0))
...
```{r unac-regional, fig.cap = "Quantidade de Unidades de Acolhimento por Público Atendido  - 2014 - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
grafico <- cras_gpte(cras_2022, q65_1_1, "2022") %>%
  #bind_rows(cras-gpte(creas_2018, q16, "2018")) %>%
  #bind_rows(cras-gpte(creas_2019, q15, "2019")) %>%
  #bind_rows(cras-gpte(creas_2020, q20, "2020")) %>%
  #bind_rows(cras-gpte(creas_2021, q20, "2021")) %>%
  #bind_rows(cras-gpte(creas_2022, q20, "2022")) %>%
