...
```{r municipios-formas-apoio, fig.cap = "Percentual de municípios por formas de apoio técnico recebido do Estado nos 12 meses anteriores à pesquisa, segundo grandes regiões - Brasil, 2017", fig.footer = "Fonte: MDS, Censo SUAS."}
