...
Essa seção apresenta informações sobre as unidades físicas do SUAS e sua evolução ao longo do tempo. 
Esse item contempla as seguintes informações: a) quantidade de unidades administrativas da rede socioassistencial,
...
unidades para 8.557. O \Cref{fig:quantitativo-CRAS} apresenta a evolução do quantitativo de
...
dispõe desta unidade pública.\footnote{estas informações são referentes ao preenchimento do Censo SUAS, 
é possível que no determinado período esta undiade pública não tenha preenchido o forumulário}.


Em relação a quantidade de CRAS por município, observa-se que 3 regiões o CRAS não estar universalizado, 
sendo elas Nordeste, Sudeste e Sul conforme \Cref{fig:municipios-CRAS}.
...
Ao observar o número de CRAS por municípios, levando-se em conta o porte populacional, verifica-se que os 35 municípios do país que não possuem CRAS estão concentrados em municípios de pequeno porte \Cref{fig:CRAS-porte}.
...
```{r cmas-be, fig.cap = "Percentual de Conselho Municipal que aprovou em Resolução os critérios e prazos para acesso aos Benefícios Eventuais"}
...
```{r ceas-be, fig.cap = "Percentual de Conselho estadual que aprovou em Resolução os critérios e prazos para acesso aos Benefícios Eventuais"}
