...
O (\Cref{fig:CREAS-MSE}) sinaliza que 89% dos CREAS ofertam esse serviços, esse número aumentou 8 pontos percentuais se comparado a ano de 2017.\footnote\footnote{gráfico são a partir do ano de 2017 em decorrência do início da modalidade da pergunta no formulário do Censo SUAS}
