...
#grafico <- estados_sec_exc(ge_2013, q1, "2013") %>%
#grafico <- estados_sec_exc(ge_2014, q1, "2014") %>%
#grafico <- estados_sec_exc(ge_2015, q1, "2015") %>%
#grafico <- estados_sec_exc(ge_2016, q1, "2016") %>%
#grafico <- estados_sec_exc(ge_2017, q1, "2017") %>%
#grafico <- estados_sec_exc(ge_2018, q_1, "2018") %>%
#grafico <- estados_sec_exc(ge_2019, q1, "2019") %>%
#grafico <- estados_sec_exc(ge_2020, q1, "2020") %>%
#grafico <- estados_sec_exc(ge_2021, q1, "2021") %>%
#grafico <- estados_sec_exc(ge_2022, q1, "2022") %>%
...
A produção de informações articuladas com Vigilância Socioassitencial
também é uma ação importante para identificação das famílias
vulnerabilizadas no território. Esses dados devem subsidiar busca ativa,
...
undiades do cadastro único (96,82%). Já as ações de agendamento para
...
Revisão cadastral no ambito dos postos dos Cadastro Único dos
...
```{r IGD_CMAS, fig.footer="Fonte: MDS, Censo SUAS."}
...
```{r CRAS-acessibilidade-situacao}
...
```{r CREAS-acessibilidade-situacao}
...
```{r postcad-acessibilidade-situacao}
