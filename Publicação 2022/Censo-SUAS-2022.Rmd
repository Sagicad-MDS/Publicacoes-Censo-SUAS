...
# essa pergunta foi feita até 2019, após não se colocou mais
  ...
  ggplot(aes(x = Categoria, y = Percentual, group = Nível)) +
  geom_col(aes(fill = Nível), position = position_stack(reverse = TRUE)) +
  geom_text_repel(aes(y=Posição, label = label_percent(accuracy = 0.1, decimal.mark = ",")(Percentual))) +
  scale_y_continuous(expand = expand_scale(mult = c(0, .1))) +
  theme(legend.position="bottom",
        legend.title = element_blank(),
        axis.title = element_blank(),
...
#  geom_text(aes(label = percent(Percentual), y=Percentual+0.08), position = position_dodge(width = 0.9)) +
  geom_text(aes(label = label_percent(accuracy = 0.1, decimal.mark = ",")(Percentual), y=Percentual+0.08), position = position_dodge(width = 0.9)) +
  scale_y_continuous(expand = expand_scale(mult = c(0, .1))) +
  coord_flip() +
  theme(legend.position="bottom",
        legend.title = element_blank(),
