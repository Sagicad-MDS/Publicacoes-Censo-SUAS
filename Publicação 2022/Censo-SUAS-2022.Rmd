...
```{r creas-quantitativo, fig.cap = "Evolução do quantitativo de CREAS; Brasil e grandes regiões; 2012, 2017 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r CREAS-municipios, fig.cap = "Evolução do percentual de municípios com CREAS, Brasil e grandes regiões - 2012, 2017 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r CREAS-quantidade-municipios, fig.cap = "Evolução do quatitativo de municípios com CREAS, Brasil e grandes regiões - 2012, 2017 e 2022", fig.footer = "Fonte: MDS, Censo SUAS"}
...
grafico <- f_percentual_municipios_regiao_ano(creas_2012, IBGE, "2012") %>% 
  ...
  ggplot(aes(x = Região, y = n, group = Ano)) +
  geom_col(aes(fill = Ano), position="dodge") +
  geom_text(aes(label = n), hjust = -0.1, position = position_dodge(width = 0.9), angle = 90) +
  scale_y_continuous(expand = expand_scale(mult = c(0, .12))) +
  theme(legend.position="bottom",
        legend.title = element_blank(),
        axis.title = element_blank(),
        axis.ticks = element_blank(),
