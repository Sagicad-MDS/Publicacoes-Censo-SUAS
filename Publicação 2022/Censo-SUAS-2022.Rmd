...
grafico <- ord_despesa(ge_2013, q54, "2013") %>%
  bind_rows(ord_despesa(ge_2014, q54, "2014")) %>%
  ...
  #antes de criar formulario do fundo, existia esta questão no do gestor estadual, mas os dados não estao rodando
...
grafico <- ord_despesa(gm_2013, q27, "2013") %>%
  bind_rows(ord_despesa(gm_2014, q33, "2014")) %>%
  #bind_rows(ord_despesa(gm_2015, q27, "2015")) %>%
  #bind_rows(ord_despesa(gm_2016, q27, "2016")) %>%
  #bind_rows(ord_despesa(gm_2017, q27, "2017")) %>%
  ...
  #muda de formulário mas a pergunta é a mesma. entretanto não consegui rodar.
...
Sobre a estrutura física das unidades exclusivas do Cadastro Único, a sua maioria, mais de 85%, se encontram na sede da Secretaria de Assistência Social (61%) ou em postos exclusivos dos municípios (24,3%). Os demais percentuais são encontrados em outra unidade administrativa, em um serviço integrado, OSC´s, conselho ou escola.  

Quanto a presença de estrutura física dos postos do Cadastro Único a acessibilidade avançou nos últimos anos conforme ... 
