...
cpop_2019 <- read_excel("../Censo SUAS 2019/3 - Centro Pop/Censo_SUAS_2019_Centro_POP_ Dados_Gerais (1).xls", sheet = 1)
...
```{r plan_apoio_tec, fig.cap = "Percentual de Estados que possiem Plano de Apoio Técnico pactuado na CIB - Brasil, 2013 - 2017 - 2022", fig.footer = "Fonte: MDS, Censo SUAS"}
...
```{r conc_estado, fig.cap = "Percentual de estados que realizaram concursos para trabalahdores nível superior do SUAS - Brasil, 2020 - 2021 - 2022", fig.footer = "Fonte: MDS, Censo SUAS"}
...
Trata-se de um registro público eletrônico, a partir do qual podem ser produzidas informações com recorte regional e territorial para instrumentalizar as políticas sociais, em especial as políticas socioassistenciais, por meio da vigilância socioassistencial com a identificação e a prevenção de situações de risco, vulnerabilidade social e seus agravos nos diferentes territórios. 

Identifica-se esta ferramenta como um instumento que fomenta a função de Vigilância Socioassistencial a identificar  vulnerabildiades e riscos no território para nutir intervenções continuadas, sistematicas e integrada para garantir a capacidade protetiva das famílias através dos serviços, benefícios e programas socioassistenciais.

Este paragráfo tem como objetivo referenciar sobre a Gestão do Cadastro Único nos Estados e municípios. Os locais do Cadastro podem ser encontrados em unidades exclusivas ou na rede de atendimento socioassistencial. Dados do Censo SUAS 2022 destaca que xx% (2.892) são unidades exclusivas do Cadastro Único e xx estão em unidades da rede socioassistencial \footnote{os dados dos locais do Cadastro Único na rede socioassistencial CRAS, CREAS E CENTRO POP serão abordadas nos respectivos temas}.



```{r postos-cadunico, fig.cap = "Evolução de Postos do Cadastro Único - 2015 - 2017 - 2022", fig.footer = "Fonte: MDS, Censo SUAS.",eval=FALSE}
...
<!-- não sei porque não estar gerando    -->
