...
cpop_2022 <- read_excel("../Censo SUAS 2022/3 - CENTRO POP/Censo_SUAS_2022_Centro_POP_dados_gerais.xlsx", sheet = "Sheet1")
...
unac_2022 <- read_excel("../Censo SUAS 2022/4 - UNIDADE DE ACOLHIMENTO/Censo_SUAS_2022 _ Unidades_de_Acolhimento_dados_gerais.xlsx", sheet = "Censo SUAS 2022 Dados Gerais Ac")
...
```{r CRAS-acessibilidade, fig.cap = "Evolução percentual de CRAS segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil; 2010, 2016 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r CREAS_acessibilidade, fig.cap = "Evolução percentual de CREAS segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil; 2010, 2016 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
tabela <- equip_acessibilidade(creas_2010, q9_1, "2010", "1") %>%
  ...
  bind_rows(equip_acessibilidade(creas_2016, q9.1, "2016", "1")) %>%
  bind_rows(equip_acessibilidade(creas_2016, q9.2, "2016", "2")) %>% 
  bind_rows(equip_acessibilidade(creas_2016, q9.3, "2016", "3")) %>% 
  bind_rows(equip_acessibilidade(creas_2016, q9.4, "2016", "4")) %>% 
