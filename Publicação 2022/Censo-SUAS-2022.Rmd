...
governamentais (BRASIL, 2012).},a IV Conferência Nacional de Assistência Social 
teve como deliberação a construção e implementação do Sistema Único de 
...
<!-- Valdson, é possível colocar em quantidade e não percentual? -->
...
<!-- Valdson ... não consegui identificar porque estar dando NA -->
...
dúvidas sobre serviços, programas entre outros é realizada pela grande maioria das
...
if(gera.graficos.office) grafico %>% graph2office(file="graficos", append = TRUE)
```
Sobre ações de busca ativa ...

<!-- os dados em branco são contabilizados ... a partir de 2021 cresce muito as marcações em branco por isso a discrepancia nas informações. Avaliar a pertinencia, sobretudo pq 2021 e 2022 são referentes a periodos pandemicos.}). -->
...
A visita domiciliar permite uma aproximação com aspectos do cotidiano das famílias,
trata-se de uma forma de coleta das informações por meio do encontro até as família. 
Essa ação objetiva assegurar o acesso a inclusão ou atualização na residencia. 
De acordo com informações do (\Cref{fig:visit_dom}) as
...
```{r sit_imovel, fig.cap = "Evolução dos CRAS segundo situação do imóvel – Brasil, 2007 a 2017", fig.footer = "Fonte: MDS, Censo SUAS."}
...
<!-- O ideal seria colocar em número em vez de percentual -->
...
```{r qtd_trab_uf, fig.cap ="Evolução da quantidade de trabalhadores nas Secretarias Estaduais de Assistência Social - Brasil, 2012 a 2022" }
...
```{r uf_trab_form, fig.cap ="Percentual de trabalhadores nas Secretarias Estaduais de Assistência Social, segundo escolaridade - Brasil, 2012 a 2022" }
...
MDS, Censo SUAS.
```{r uf_trab_prof, fig.cap ="Percentual de trabalhadores nas Secretarias Estaduais de Assistência Social, segundo profissão - Brasil, 2012 a 2022" }
...
```{r uf_equip_form, fig.cap ="Quantidade de Trabalhadores segundo a formação profissional - CRAS - Brasil, 2012 a 2022" }

```

```{r uf_equip_form, fig.cap ="Quantidade de Trabalhadores segundo a formação profissional - CREAS - Brasil, 2012 a 2022" }

```

```{r uf_equip_form, fig.cap ="Quantidade de Trabalhadores segundo a formação profissional - Centro Pop - Brasil, 2012 a 2022" }

```



```{r uf_equip_vol, fig.cap ="Percentual de unidades de CRAS que possuem equipe volante  - Brasil, 2012 a 2022" }

```



```{r unid_acol, fig.cap ="Evolução da quantidade de trabalhadores (as) das Unidades de Acolhimento - Brasil, 2012 a 2022" }

```


```{r trab_sexo, fig.cap ="Percentual de trabalhadores (as) quanto ao sexo - estadual " }

```



```{r trab_sexo, fig.cap ="Percentual de trabalhadores (as) quanto ao sexo - municipal " }
...
Em relação a realização de concurso público para trabalhadores (as) de nível 
