...
Aldultos e Famílias: há 997 Unidades, no período entre 2014 e 2022 houve um crescimento de 64% no Brasil;
...
```{r unac-publico, fig.cap = "Quantidade de Unidades de Acolhimento por principal público atendido  - 2014 - 2022", fig.footer = "Fonte: MDS, Censo SUAS.", fig.height = 10}
...
Quanto a presença das unidades do Cadastro Único, os dados do censo suas 2022 sinaliza 2.892 Postos do Cadastro Único. Número que vem crescendo numa média Nacional de 14% nos últimos 2 anos. Destaca-se a Região do Centro Oeste na qual teve crescimento de 25% neste mesmo período.
...
```{r CREAS-abordagem-social, fig.cap = "Quantidade de CREAS que realizam o Serviço Especializado em Abordagem Social, 2018 a 2022", fig.footer = "Fonte: MDS, Censo SUAS"}
