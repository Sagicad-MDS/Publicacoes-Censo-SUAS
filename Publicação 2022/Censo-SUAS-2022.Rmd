...
gerh_2019 <- read_excel("../Censo SUAS 2019/GestÆo Estadual/Censo_SUAS_2019_dados_gerais_GE_RH_divulgaÆo.xlsx",sheet = 1)
...
gm_rh_2013 <- read_excel("../Censo SUAS 2013/Gestão Municipal/Censo_SUAS_2013_Gestão_Municipal_Dados_Gerais_Divulgação.xlsx", sheet = 1)
...
No que se refere ao Planejamento, trata-se de uma obrigatoriedade para existência do Sistema Único e repasse de confinanciamento. O Plano Estadual de Assistência Social (PEAS) deve ser aprovado pelo Conselho Estadual de Assistência Social (CEAS). Os dados do \cref{fig:PEAS} sinalizam que a partir de 2020 há um descrecimo desta atualização com devida aprovação do conselho\footnote{Para os anos de 2016, 2017, 2018 e 2019 as perguntas alteraram, impossibilitande a linha histórica}\footnote{Para os municípios não foi possivel fazer essa linha histórica em decorrencia de mudanças nas perguntas}.
...
Apesar destes avanços, há registros de não cofinanciamento estadual, na qual caiu de 25,93% (7) no ano de 2012 para 3,85% (1) em 2022 (1)\footnote{o Estado do Acre informa que não cofinancia os municípios}.
...
O ordenador de despesa responde pela emissão de empenho, autorização de pagamento dos recursos do fundo de assistencia social. Assim, recomenda-se que este tenha amplo conhecimento sobre a política. O \cref{fig:estado_ord_despesa} sinaliza que 73% dos gestores estaduais são ordenadores de despesa do fundo estadual. Dado que reduziu a partir de 2018.
...
grafico <- f_quantitativo_regiao_ano(ceconv_2014, Região, "2014") %>%
  bind_rows(f_quantitativo_regiao_ano(ceconv_2015, Regiao, "2015")) %>%
  bind_rows(f_quantitativo_regiao_ano(ceconv_2016, Regiao, "2016")) %>%
  bind_rows(f_quantitativo_regiao_ano(ceconv_2017, Regiao, "2017")) %>%
  bind_rows(f_quantitativo_regiao_ano(ceconv_2018, Regiao, "2019")) %>%
  #bind_rows(f_quantitativo_regiao_ano(ceconv_201, Regiao, "2018")) %>% - carregar
...
```{r creas-quantitativo, fig.cap = "Evolução do quantitativo de CREAS, segundo grandes regiões; 2012, 2017 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
  ...
  grafico <- f_quantitativo_regiao_ano(creas_2012, IBGE, "2012") %>%
   #bind_rows(f_quantitativo_regiao_ano(creas_2009, IBGE, "2009")) %>%
...
A existência de computadores com acesso à internet é um importante aspecto a ser observado quando se avalia a infraestrutura dos CREAS. Em 2022, 99% dos CREAS possuem computadores com acesso à internet conforme o \cref{fig:CREAS-internet-percentual}. Números que avançou em todas as regiões, em especial, na Região Norte conforme linha histórica desta evolução apresentada no gráfico abaixo.

```{r CREAS-internet-percentual, fig.cap = "Evolução percentual de CREAS com computadores com acesso à internet – Brasil; 2012, 2017 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
Os Centro Pop estão presentes em municípios de grande porte e metrópoles, o \cref{fig:cpop-porte} sinaliza que 59% dos municípios de grande porte possui pelo menos uma unidade, e para metropoles 100% possuem unidades de centro pop, sendo 59% entre duas a três unidades, 24% uma unidade e 18% de 4 a 6 undiades de Centro Pop. Há presenta também em múnicípios de médio porte, com destaque para 5,9% dos municípios.
...
Em 2022,95% dos Centros Pop destacam computador com acesso à internet. O \cref{fig:cpop-internet-percentual} referencia essa evolução por Regiões do Brasil, as regiões Centro Oeste e Sul possuem 100% das undiades com acesso a internet e a região Norte com maior desafio de acesso, com 75% das unidades de Centro Pop com acesso a internet.
...
Centro Dia são unidades públicas especializadas para qtender pessoas com deficiência e suas famílias. Ela estar inserida no ambito da proteção social espceial de média complexidade. No ano de 2015 identifica-se no Brasil 1.340 unidades. Em 2022 há um crescimento de 40,7% destas unidades conforme pode ser observada no \cref{fig:quantitativo-Centrodia}.
...
As informações sobre as Unidades de Acolhimento que são tipificadas, sinalizam um crescimento em todos os públicos.\footnote{Resolução CNAS 109/2009}. Através do \cref{fig:unac-publico} destaca-se as seguintes informações sobre as Unidades de Acolhimento Institucional:

- Crianças e Adolescentes: há 2.916 Unidades, no período entre 2014 e 2022 houve um crescimento de 6% no Brasil;

- Pessoas Iodsas: há 2.059 Unidades, no período entre 2014 e 2022 houve um crescimento de 42% no Brasil;

- Adultos e Famílias: há 997 Unidades, no período entre 2014 e 2022 houve um crescimento de 64% no Brasil;

- Exclusivamente Pessoas Adultas com Deficiência: há 362 Unidades, no período entre 2014 e 2022 houve um crescimento de 83% no Brasil\footnote{As unidades de Residência Inclusiva são as unidades tipificadas para atendimento de jovens e adultos com deficiência. Assim, entende-se a característica do público de unidades exclusivas para pessoas Adultas com Deficiência deve estar alinhado esta caracterisica de unidade de acolhimento}.

- Mulheres em Situação de Violência Doméstica ou Familiar: há 112 Unidades, no período entre 2014 e 2022 houve um crescimento de 14% no Brasil;

- Jovens Egressos dos Serviços de Acolhimento: há 67 Unidades, no período entre 2014 e 2022 houve um crescimento de 72% no Brasil\footnote{O Serviços de República é a descrição tipificada para prioritariamente público de 18 a 21 anos após desligamento de serviços de acolhimento insitucional}.

No que se refere a unidades de atenção exclusiva para crianças com deficiência não é uma unidade tipificada, sendo a orientação deste público estar em unidades de acolhimento para Crianças e Adolescentes. Como destaca o \cref{fig:unac-publico} trata-se de uma unidade que vem reduzindo ao longo do tempo. 


```{r unac-publico, fig.cap = "Quantidade de Unidades de Acolhimento por principal público atendido  - 2014 - 2022", fig.footer = "Fonte: MDS, Censo SUAS.", fig.height = 9.2}

prepara_dados = function(df, q, nome_grupo){
  q <- enquo(q)
  nome_grupo <- quo_name(nome_grupo)

  df %>%
    select(!! nome_grupo := !! q) %>%
    gather("Grupo2","Grupo1") %>%
    mutate(Grupo1 = case_when(
      Grupo1 == "Crianças adolescentes" |
      Grupo1 == "Crianças/adolescentes"~"Crianças / Adolescentes",
      Grupo1 == "Adultos e famílias em situação de rua e ou migrantes" |
      Grupo1 == "Adultos e famílias em situação de rua e/ou migrantes" |
      Grupo1 == "Famílias desabrigadas desalojadas" |
      Grupo1 == "Famílias desabrigadas/desalojadas" |
      Grupo1 == "Adultos e famílias" |
      Grupo1 == "Adultas(os) e famílias"~"Adultas/os e famílias",
      Grupo1 == "Exclusivamente para pessoas adultas com Deficiência" |
      Grupo1 == "Exclusivamente pessoas adultas com Deficiência"~"Exclusivamente pessoas adultas com deficiência",
      Grupo1 == "Exclusivamente crianças adolescente com Deficiência" |
      Grupo1 == "Exclusivamente crianças/adolescente com Deficiência"~"Exclusivamente crianças/adolescente com deficiência",
      Grupo1 == "Mulheres em situação de violência"~"Mulheres em situação de violência doméstica ou familiar",
      Grupo1 == "Jovens egressos de serviços de acolhimento" |
      Grupo1 == "Jovens egressas(os) de serviços de acolhimento"~"Jovens egressas/os de serviços de acolhimento",
      Grupo1 == "Pessoas Idosas"~"Pessoas idosas",
      TRUE ~ Grupo1)) %>%

    filter(!is.na(Grupo1)) %>%
    group_by(Grupo2, Grupo1) %>%
    summarise(n=n()) %>%
    mutate(Percentual = n/sum(n))
}

tabela <- prepara_dados (unac_2014, q2, "2014") %>%
  bind_rows(prepara_dados(unac_2015, q2, "2015")) %>%
  bind_rows(prepara_dados(unac_2016, q2_1, "2016")) %>%
  bind_rows(prepara_dados(unac_2017, q1.1, "2017")) %>%
  bind_rows(prepara_dados(unac_2018, q_1_1, "2018")) %>%
  bind_rows(prepara_dados(unac_2019, q1_1, "2019")) %>%
  bind_rows(prepara_dados(unac_2020, q1_1, "2020")) %>%
  bind_rows(prepara_dados(unac_2021, q1_1, "2021")) %>%
  bind_rows(prepara_dados(unac_2022, q1_1, "2022")) %>%

  mutate(Grupo1=str_wrap(Grupo1,width=21))
...
grafico<-tabela %>%
  mutate(Grupo1 = factor(Grupo1, levels = ordenado)) %>%
  f_grafico_col_numero_flip(Grupo1, n, Grupo2, 2)
...
No que se refere a quantidade total destas unidades de acolhimento por porte populacional, destaca-se que há concentração nos municípios de grande porte e metrópole. Todas as metrópoles possuem registro de mais de 10 unidades. O \cref{fig:unac-porte} também sinaliza que 74% dos municípios de pequeno porte I não dispõem de serviços de alta complexidade. 
...
Quanto a presença das unidades do Cadastro Único, os dados do Censo SUAS 2022 indicam a existência de 2.892 Postos do Cadastro Único. Número que vem crescendo numa média Nacional de 14% nos últimos 2 anos. Destaca-se a Região do Centro Oeste na qual teve crescimento de 25% neste mesmo período.
...
Em relação ao local onde estão estas unidades, \Cref{fig:posto_cadunico}. A maioria destas unidades, 60,9% encontra-se na secretaria de assistencia social. A segunda proporção são postos exclusivos, com detaque para algumas undiades presentes em escolas, conselhos e OSCS.
...
A acessibilidade possui um leve avanço nos últimos anos, com execeção da rota ascessivel aos principais espaços os demais itens de acessbilidade avançaram conforme pode ser observado através do \cref{fig:postcad-acessibilidade}.
...
Em relação a computadores com acesso a internet, os dados do Censo SUAS 2022 sinaliza que 99% das unidades dispõe de equipamentos com esta estrutura conforme pode ser observado no \cref{fig:postcad-internet-percentual}.
...
A Proteção remonta um conjunto de direitos que é viabilizado através do acesso a serviços, benefícios programas voltados ao atendimento de demandas de Proteção Social. A atuação deve estar integrada as funções de Vigilância Socioassistencial, Proteção Social e Defesa de direitos. O objetivo desta seção é abordar um panorama geral dos principais serviços e Benefícios do SUAS.
...
A Proteção Social Básica possui uma atuação protetiva, proativa e preventiva. O objetivo é antecipar possíveis desproteções sociais a que está sujeita a coletividade.

### Serviço de Proteção e Atendimento Integral à Família (PAIF)

O PAIF compõe um conjunto de atenções conjugada a seguranças sociais referenciadas a undiade de CRAS. De acordo com Tipificação Nacional dos Serviços Socioassistenciais, o PAIF "consiste no trabalho social com família, de caráter contínuado, com a finalidade de fortalecer as função protetiva das famílias, prevenir a ruptura dos seus vínculos, promover seu acesso e usufruto do direito".

A respeito das principais ações desenvolvidas no ambito do PAIF, destaca que as três atividades mais realizadas pelas unidades são visitas domiciliares, encaminhamento para o Cadastro Único e acolhida particularizada. O \Cref{fig:paif_cras} tambémn destaca que 91% das unidades informam que usam Prontuário para acompanhamento das famílias. Destaca-se que o registro do acompanhamento familiar é obrigatório através de Prontuário\footnote{Manual de instruções para utilização do Prontuário SUAS}. Ainda conforme as atividades do PAIF destaca-se que a acolhida em grupo é a atividade que possuem menor percentual em relação a esse grupo de atividades mencionadas no gráfico\footnote{o \Cref{fig:paif_cras} possui esse conjunto de informações a partir do ano de 2015}.

```{r paif_cras, fig.cap = "Atividades desenvolvidas pelos PAIF/CRAS - Brasil, 2015 e 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#2022
  categoria <- case_when(!! cod_categoria == "1"~"Acolhida em Grupo realizada por profissional de nível superior",
                         !! cod_categoria == "2"~"Acolhida Particularizada realizada por técnica(o) de nível superior",
                         !! cod_categoria == "3"~"Grupo/oficina com famílias",
                         !! cod_categoria == "4"~"Visitas Domiciliares",
                         !! cod_categoria == "5"~"Acompanhamento de famílias",
                         !! cod_categoria == "6"~"Encaminhamento para inserção/atualização de famílias no Cadastro Único",
                         !! cod_categoria == "7"~"Registro dos acompanhamentos familiar em prontuário ou registro das famílias /acompanhadas",
                         !! cod_categoria == "0"~"Oferta de Benefícios Eventuais")
 ...
 tabela <- paif_cras (cras_2015,q13_1,"2015","1") %>%
  bind_rows(paif_cras(cras_2015,q13_2,"2015","2")) %>%
  bind_rows(paif_cras(cras_2015,q13_8,"2015","3")) %>%
  bind_rows(paif_cras(cras_2015,q13_9,"2015","4")) %>%
  bind_rows(paif_cras(cras_2015,q13_3,"2015","5")) %>%
  bind_rows(paif_cras(cras_2015,q13_17,"2015","6")) %>%
  bind_rows(paif_cras(cras_2015,q13_6,"2015","7")) %>%
  bind_rows(paif_cras(cras_2015,q13_16,"2015","0")) %>% 
   

  bind_rows(paif_cras(cras_2022,q13_1,"2022","1")) %>%
  bind_rows(paif_cras(cras_2022,q13_2,"2022","2")) %>%
  bind_rows(paif_cras(cras_2022,q13_4,"2022","3")) %>%
  bind_rows(paif_cras(cras_2022,q13_7,"2022","4")) %>%
  bind_rows(paif_cras(cras_2022,q13_8,"2022","5")) %>%
  bind_rows(paif_cras(cras_2022,q13_14,"2022","6")) %>%
  bind_rows(paif_cras(cras_2022,q13_20,"2022","7")) %>%
  bind_rows(paif_cras(cras_2022,q13_24,"2022","0")) %>%
...
```{r povos-tradicionais_cras, fig.cap = "Percentual de CRAS que possuem povos e comunidades tradicionais no território de abrangencia, 2012 - 2022", fig.footer = "Fonte: MDS, Censo SUAS.", eval=FALSE}
...
```{r CRAS-tradicionais, fig.cap = "Percentual de CRAS que atendem povos e comunidades tradicionais -  por grupos , Região - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}

grafico <- f_selecao_regiao_ano (cras_2022, q65_1_1, "Sim", IBGE, "Povos Indígenas")%>%
    bind_rows(f_selecao_regiao_ano(cras_2022, q65_2_1, "Sim", IBGE, "Comunidade Quilombola"))%>%
    bind_rows(f_selecao_regiao_ano(cras_2022, q65_3_1, "Sim", IBGE, "Comunidade Ribeirinha"))%>%
    bind_rows(f_selecao_regiao_ano(cras_2022, q65_4_1, "Sim", IBGE, "Povos Ciganos"))%>%
    bind_rows(f_selecao_regiao_ano(cras_2022, q65_5_1, "Sim", IBGE, "Povos de Matriz Africana e de terreiro"))%>%
    bind_rows(f_selecao_regiao_ano(cras_2022, q65_6_1, "Sim", IBGE, "Comunidades Extrativistas"))%>%
    bind_rows(f_selecao_regiao_ano(cras_2022, q65_9_1, "Sim", IBGE, "outros povos e comunidades tradicionais"))%>%

  f_grafico_col_group_percent(Região, Percentual, Ano, 4)
...
```{r paefi_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações de riscos em decorrencia de situações e ciclos de vida - Brasil  2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r uf_trab_vin, fig.cap ="Percentual de trabalhadores (as) nas Secretarias Estaduais de Assistência Social, segundo tipo de vínculo - Brasil, 2010 a 2022", fig.height = 9.2 }
...
```{r munic_trab_vin, fig.cap ="Percentual de trabalhadores (as) nas Secretarias Municipais de Assistência Social, segundo tipo de vínculo - Brasil, 2013, 2017 e 2022", eval=FALSE}
...
grafico <- f_nomex_somay_nomegrupo(gm_rh_2013, "2013", q42a_4, "Estatutários") %>%
  bind_rows(f_nomex_somay_nomegrupo(gm_rh_2013, "2013", q42b_4, "Celetistas")) %>%
  bind_rows(f_nomex_somay_nomegrupo(gm_rh_2013, "2013", q42c_4, "Somente Comissionados")) %>%
  bind_rows(f_nomex_somay_nomegrupo(gm_rh_2013, "2013", q42d_4, "Outros Vínculos")) %>%
