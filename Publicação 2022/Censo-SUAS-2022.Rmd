...
idconselho_2021 <- read_excel("../ID CONSELHO/ID CONSELHO 2021.xlsx",sheet = 1)
idconselho_2022 <- read_excel("../ID CONSELHO/ID CONSELHO - 2022.xlsx",sheet = 1)
...
```{r estados-PEAS, fig.cap = "Percentual de Secretarias Estaduais com, Plano Estadual de Assistência Social atualiziado", fig.footer = "Fonte: MDS, Censo SUAS "}
...
<!--reencresver após geração grafico#A modalidade na qual foi observado o menor percentual foi a de capacitações à distância, da qual participaram 29,7% dos municípios. Esse tipo de apoio ocorreu em 53,9% dos municípios da região Sudeste e em 14,3% dos municípios da região Centro-Oeste-->
...
```{r fig.cap = "Evolução dos CRAS segundo situação do imóvel – Brasil, 2007 a 2017", fig.footer = "Fonte: MDS, Censo SUAS."}
...
**Capítulo 7 - INDICADORES DO SUAS**
