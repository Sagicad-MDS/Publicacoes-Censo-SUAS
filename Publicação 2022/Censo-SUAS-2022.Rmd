...
if(length(novos.pacotes) > 0) {install.packages(novos.pacotes, repos = "htttp: //cran.us.r-project.org")}
...
Gestão Estadual                       & 26                        \\
Gestão Municipal\mpfootnotemark[1]    & 5.481                     \\
Conselhos Estaduais\mpfootnotemark[1] & 27                        \\
Conselhos Municipais                  & 5.359                     \\ \bottomrule
\end{tabular}
\floatfoot{Fonte: MDS, Censo SUAS.}
\footnotetext[1]{O Distrito Federal responde aos questionários voltados à Gestão Municipal e aos Conselhos Estaduais.}
\end{table}
...
```{r CREAS-municipios, fig.cap = "Evolução de CREAS por número de municípios, 2012 - 2017 - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}

```

```{r CREAS-municipios, fig.cap = "Evolução de CREAS Regionais (res. 21/2023)", fig.footer = "Fonte: MDS, Censo SUAS."}
