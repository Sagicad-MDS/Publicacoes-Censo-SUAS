...
```{r munic_trab_form, fig.cap =" Percentual de trabalhadores nas Secretarias municipais de Assistência Social, segundo escolaridade e profissão - Brasil, 2013 a 2022"}
...
### REPRESENTÇAÃO E COMPOSIÇÃO DOS CONSELHOS DE ASSISTÊNCIA SOCIAL 


De acordo com a resolução CNAS 99/2023, "a representação dos usuários nas instâncias de participação e de deliberação do SUAS ocorrerá por meio de usuários integrantes de suas organizações representativas, democraticamente designados, preferencialmente dentre aquelas vinculadas aos serviços, programas, projetos, benefícios, transferência de renda e defesa dos direitos dos usuários da Política de Assistência Social". 

Os dados apresentados no (\Cref{fig:usu_ceas}) sinaliza que a maior representação dos conselhos estaduais são representantes de fóruns de usuários, beneficiários do Programa Bolsa Família e BPC representando respetivamente 73%, 50% e 38% respectivamente. 
...
Os dados do (\Cref{fig:usu_cmun}) sinaliza que o maior percentual de representação de usuários dos conselhos municipais são da proteção social Básica, programa Bolsa Família e BPC, sendo respectivamente 77%, 70% e 42%.
...
Em relação a representação de trabalhadores (as) nos conselhos Estaduais de Assitência Social
