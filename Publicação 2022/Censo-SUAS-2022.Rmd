...
Os dados de CRAS que funcionam com imóvel próprio evoluiu significativamente de 2008 a 2022. Destaca-se que o primeiro ano da série histórica (\Cref{fig:CRAS-imovel}) possuia 44% de CRAS com imóvel próprio, dado que chega em 2022 com 60%. Dados com CRAS que funcionam com imóveis alugados passam por redução de 48% para 31%.
...
<!-- Observa-se ainda aumento no percentual de CREAS que funcionam em imóveis cedidos: eram 6,8% em 2008, o maior valor da série histórica chega a 9,1% conforme \Cref{fig:creas-situacao}.\footnote{Para os anos de 2018 e 2019 esse dado não foi computado no Censo SUAS} -->
