...
O objetivo é conhecer, incluir e aprimorar as políticas sociais. Assim, esses dados subsidiam a realização de diagnósticos, ações de planejamento, busca ativa, monitoramento e avaliação. A gestão é interfederativa e descentralizada na qual os locais de cadastramento são efetuados pelos municípios. Estas unidades podem ser encontradas em unidades exclusivas ou na rede de atendimento socioassistencial de CRAS, CREAS, Centro Pop. 

Dados do Censo SUAS mostram uma evolução de locais de cadastramento. A partir de 2017 aumento 54% de postos do Cadastro Único conforme pode ser observado na tabela \ref{tab:qtd_equipamentos}. Sobre a distribuição destas locais de cadastro único, destaca-se que em 2022, 31% (2.892) são unidades exclusivas do Cadastro Único e 68% estão em unidades da rede socioassistencial \footnote{CRAS, CREAS e CENTRO POP}.
...
\toprule
Equipamento             & 2017  & 2018 & 2019 & 2020 &  2021 & 2022            \\ \midrule
...
Sobre as unidades exclusivas do Cadastro Único, a sua maioria mais de 85%, se encontram na sede da Secretaria de Assistência Social ou em postos exclusivos dos municípios. Os demais percentuais são encontrados em outra unidade administrativa, em um serviço integrado, OSC´s, conselho ou escola.  

Quanto a presença de estrutura de Cadastro Único no orgão gestor e profissionais específicos, destaca-se que   
