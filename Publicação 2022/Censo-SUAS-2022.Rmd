...
O quantitativo de CRAS dobrou entre 2007 e 2022, passando de 4.195 unidades para 8.557. Desde 2007, 4.361 novas unidades de CRAS foram criadas nos territórios municipais - crescimento. Abaixo evolução por grandes regiões de desenvolvimento.  
...
grafico <- f_quantitativo_regiao_ano(cras_2007, Gran_reg, "2007") %>%
  ...
  #binda_rows(f_quantitativo_regiao_ano(cras_2022, Região, "2022")) %>%
...
#  graph2office(file="graficos", append = TRUE)
```
A Expansão em todo território nacional do número de CRAS evidencia a consolidação de uma referencia replubicana de Assistêrncia Social em todo território nacional. De acordo com os dados xx municípios não possuem CRAS.Assim, pode-se dizer que o desafio da expansão teve avanços nestes ultimos anos e deixa como nova demanda a universalização.   


#GRAFICO NÃO SERÁ GERADO
...
Dos 5.570 municípios brasileiros, 76 não possuem nenhum CRAS (1,4% do total), 4.477 (80,4%) possuem um CRAS, 722 (13,0%) de 2 a 3 CRAS, 200 (3,6%) de 4 a 6 CRAS, 58 (1,0%) de 7 a 10 CRAS e 37 (0,7%) mais de 10 CRAS (\Cref{fig:CRAS-porte}).
...
```{r eval=FALSE, fig.cap = "Evolução dos CREAS segundo situação do imóvel – Brasil, 2012 - 2017 - 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#grafico <- f_creas_imovel(creas_2012, q5, "2012") %>%
  ...
  bind_rows(f_creas_imovel(creas_2012, q5, "2012")) %>%
