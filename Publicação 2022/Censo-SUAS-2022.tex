...
Crianças e Adolescentes: há 2.916 Unidades, no período entre 2014 e 2022
houve um crescimento de 6\% no Brasil;

Pessoas Iodsas: há 2.059 Unidades, no período entre 2014 e 2022 houve um
crescimento de 42\% no Brasil;

Aldultos e Famílias: há 997 Unidades, no período entre 2014 e 2022 houve
um crescimento de 64\% no Brasil;
...
Jovens Egressos dos Serviços de Acolhimento: há 67 Unidades, no período
entre 2014 e 2022 houve um crescimento de 72\% no
...
2022 sinaliza 2.892 Postos do Cadastro Único. Número que vem crescendo
numa média Nacional de 14\% nos últimos 2 anos. Destaca-se a Região do
Centro Oeste na qual teve crescimento de 25\% neste mesmo período.
...
através de Prontuário.
\footnote{Manual de instruções para utilização do Prontuário SUAS}.
...
atividades mencionadas no gráfico
...
preventiva a ocorrências de situações de risco social. De acordo com
...
Convivência conforme já mencionado (\Cref{fig:quantitativo-CentroConv})
...
Em relação a atendimento Povos e comunidades Tradicionais,
\footnote{a partir de 2019 a pergunta foi alterada} em 2018, 31\% dos
CRAS informaram que possuem povos e comunidades tradicionais em seu
território de abrangência. Esse dado avança em relação ao ano de 2012.

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/povos-tradicionais_cras-1} \caption[Percentual de CRAS que possuem povos e comunidades tradicionais no território de abrangencia, 2012 - 2022]{Percentual de CRAS que possuem povos e comunidades tradicionais no território de abrangencia, 2012 - 2022}\label{fig:povos-tradicionais_cras}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

Em relação as especifidades desse público atendidos pelo PAIF e PAEFI,
destaca-se que há registros de atendimento tanto nos CRAS como nos
CREAS. Dados do Censo SUAS 2022 sinaliza que os povos mais atendidos em
nível de Brasil são Indígenas e Quilombolas. O
(\Cref{fig:CRAS-tradicionais}) traz estes dados por regiões.
...
O (\Cref{fig:paefi_creas}) mostra que cresceu, entre o período de 2019 a
2022, as os atendimentos de abuso e violência sexual, violência contra
mulher e crianças e adolescentes bem como situações de negligência e
abandono. O gráfico também destaca que as situações de tráfico de
pessoas tiveram aumento significativo neste período.
...
Em relação a violação em decorrência de trabalho análogo a escravidão é
...
(\Cref{fig:paefi2_creas}) também trás as situações de trabalho infantil.
Observa-se que a maior demanda atendida pelos CREAS, entre o período de
2020 e 2022, através do PAEFI é trabalho infantil. Entretanto as
situações de situações de trabalho análogo a escravidão é presente em
média 13\% dos CREAS.
...
As situações de rua atendidas pelo PAEFI tiveram uma redução de
atendimentos em todos os públicos sinalizados através
(\Cref{fig:paefi3_creas}), durante período de 2019 a 2022. Tal fato pode
ser atribuído ao período da pandemia
\footnote{O Censo SUAS 2022 é referente aos dados do ano de 2021}.
Destaca-se também que nos municípios maiores a presença de Centro Pop
conforme sinalizado (\Cref{fig:quantitativo-CentroPop})

As situações de imigração / refúgio vem crescendo no ambito das demandas
do PAEFI, os dados do (\Cref{fig:paefi6_creas})sinaliza uma redução de
74\% para 68\% dos municípios que informam não atender essa demanda e,
em sequencia, pode-se observar que todos os públicos aumentam ao longo
destes dois anos.
...
que dos seis povos e comundiades destacadas no grafico, em ambito
nacional as maiores demandas estão para os públicos de comunidades
quilombolas com 36\%, povos indígenas com 35\% e ribeirinhos com 29\%.
...
comundiades quilombolas com 55\% e a Norte com 74\% de demandas de
...
O (\Cref{fig:CREAS-MSE}) sinaliza que 89\% dos CREAS ofertam esse
serviços, esse número aumentou 8 pontos percentuais se comparado a ano
de
2017.\footnote{Série só possível de ser selecionada historicametne a partir de 2017}
...
CREAS,\footnote{Série só possível de ser selecionada historicametne a partir de 2018}
de acordo com (\Cref{fig:creas-pse-domicilio}) a quantidade de Serviço
de Proteção Social Especial para Pessoas com Deficiência e Pessoas
Idosas com equipe específica para sua execução reduz em paralelo aumenta
a oferta sem equipe exclusiva. Há redução também em relação aos
municípios que deixam de ofertar este serviços que vai de 20\% em 2018
para 31\% em 2022. O (\Cref{fig:creas-pse-domicilio}) também destaca
aumento dos municípios que realziam a oferta do Serviços, mas não no
CREAS.

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/creas-pse-domicilio-1} \caption[Percentual de CREAS que realizam Serviço de proteção social Especial para Pessoas com Deficiência, Idosas e suas Famílias, 2018 a 2022]{Percentual de CREAS que realizam Serviço de proteção social Especial para Pessoas com Deficiência, Idosas e suas Famílias, 2018 a 2022}\label{fig:creas-pse-domicilio}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
Ao analisar a oferta de serviço especializado em abordagem social pelos
municípios através do (\Cref{fig:paefi_creas}), no período de 2018 a
2022 houve uma redução da oferta deste serviço no ambito dos CREAS
\footnote{Série só possível de ser selecionada historicametne a partir de 2018 com exeção do ano de 2020}.
Destaca-se também a redução da oferta com serviços com e sem equipe
exclusiva para este serviço.

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/CREAS-abordagem-social-1} \caption[Quantidade de CREAS que realizam o Serviço Especializado em Abordagem Social, 2018 a 2022]{Quantidade de CREAS que realizam o Serviço Especializado em Abordagem Social, 2018 a 2022}\label{fig:CREAS-abordagem-social}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
organizados em diferentes modalidades de Unidades, conforme o público, e
destinam-se a famílias e/ou indivíduos afastados temporariamente do
núcleo familiar e/ou comunitários de origem. O Plano Individual de
Atendimento (PIA) é um instrumento que norteia as ações a serem
realizadas para viabilizar a proteção integral, a reinserção familiar e
comunitária e a autonomia de crianças e adolescentes afastados dos
cuidados parentais e sob proteção de serviços de acolhimento.
