...
organizados em diferentes modalidades de Unidades, conforme o público
destacado no através (\Cref{fig:unac-publico}), e destinam-se a famílias
e/ou indivíduos afastados temporariamente do núcleo familiar e/ou
comunitário de origem. Cada unidade possui metodologias de trabalho
diferenciada conforme público, entretanto o Plano Individual de
...
No território Nacional há 543 municípios que possuem este serviço
conforme dados de 2022. Esse número cresceu em relação ao ano de 2017
conforme pode ser observado (\Cref{fig:fam_acolhedora}). O gráfico
também referencia a oferta destes serviços por grandes regiões, as
regiões Sul e Sudeste se destacam como o maior número quantitativo e a
Região Nordeste em termos de crescimento proporcional neste período. AS
regiões Centro Oeste e Norte foram as que menos tiveram crescimento da
oferta do Serviço de Acolhimento em Família Acolhedora no ambito dos
municípios.
