...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados_sec_exc-1} \caption[Percentual de Estados quanto a caracteristica de estrutura administrativa, 2012 - 2022 - Brasil]{Percentual de Estados quanto a caracteristica de estrutura administrativa, 2012 - 2022 - Brasil}\label{fig:estados_sec_exc}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados-caracteristica-secretaria-2012-1} \caption[Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2012]{Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2012}\label{fig:estados-caracteristica-secretaria-2012}\floatfoot{Fonte: MDS, Censo SUAS, eval=FALSE}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados-constituicao-subdivisoes_2012-1} \caption[Percentual de estados segundo característica da estrutura administrativa da Secretaria estadual de Assistência Social - Brasil,  2012]{Percentual de estados segundo característica da estrutura administrativa da Secretaria estadual de Assistência Social - Brasil,  2012}\label{fig:estados-constituicao-subdivisoes_2012}\floatfoot{Fonte: MDS, Censo SUAS, eval=FALSE}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/municipais-constituicao-subdivisoes_2012-1} \caption[Distribuição dos órgãos gestores municipais segundo constituição/formalização de subdivisões administrativas - Brasil, 2012]{Distribuição dos órgãos gestores municipais segundo constituição/formalização de subdivisões administrativas - Brasil, 2012}\label{fig:municipais-constituicao-subdivisoes_2012}\floatfoot{Fonte: MDS, Censo SUAS, eval=FALSE}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/munic_ord_despesa-1} \caption[Percentual de municípios quanto a ordenação de despesa do fundo estadual - Brasil, 2013 - 2022]{Percentual de municípios quanto a ordenação de despesa do fundo estadual - Brasil, 2013 - 2022}\label{fig:munic_ord_despesa}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/conc_munic-1} \caption[Percentual de municípios que realizaram concursos para trabalhadores nível superior ou médio do SUAS - Brasil, 2020 - 2021 - 2022]{Percentual de municípios que realizaram concursos para trabalhadores nível superior ou médio do SUAS - Brasil, 2020 - 2021 - 2022}\label{fig:conc_munic}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/conc_estado-1} \caption[Percentual de estados que realizaram concursos para trabalhadores nível superior do SUAS - Brasil, 2022]{Percentual de estados que realizaram concursos para trabalhadores nível superior do SUAS - Brasil, 2022}\label{fig:conc_estado}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
61\% encontram-se na sede da Secretaria de Assistência Social e 24,3\%
em estruturas especificas. Os demais percentuais são encontrados em
outra unidade administrativa como, em um serviço integrado, OSC´s,
conselho ou escola.
...
vulnerabilizadas no território.

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/gestao_cad-1} \caption[Ações desenvolvidas no ambito pelos postos do Cadastro Único - Brasil, 2020, 2021 e 2022]{Ações desenvolvidas no ambito pelos postos do Cadastro Único - Brasil, 2020, 2021 e 2022}\label{fig:gestao_cad}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

Esses dados devem subsidiar busca ativa, ações de atualização cadastral,
bem como iniciativas de parcerias com outros orgãos. O gráfico
(\Cref{fig:acoes_cad}) sinaliza as ações e atividades desenvolvidas nos
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/acoes_cad-1} \caption[Ações desenvolvidas no ambito pelos postos do Cadastro Único - Brasil, 2020, 2021 e 2022]{Ações desenvolvidas no ambito pelos postos do Cadastro Único - Brasil, 2020, 2021 e 2022}\label{fig:acoes_cad}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_sede-1} \caption[Percentual de Conselhos Estaduais que possuem local/sede específico para funcionamento - Brasil, 2012 - 2022]{Percentual de Conselhos Estaduais que possuem local/sede específico para funcionamento - Brasil, 2012 - 2022}\label{fig:Ceas_sede}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_se-1} \caption[Percentual de Conselhos municipais com secretarias executivas exclusivas - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos municipais com secretarias executivas exclusivas - Brasil, 2012 - 2017 - 2022}\label{fig:Cmas_se}
\end{figure}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/IGD_CMAS-1}

Fonte: MDS, Censo SUAS.

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/IGD_CEAS-1} \caption[Quantidade de conselhos estaduais na qual são destinados pelo menos 3% dos IGB Bolsa Família e SUAS]{Quantidade de conselhos estaduais na qual são destinados pelo menos 3% dos IGB Bolsa Família e SUAS}\label{fig:IGD_CEAS}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_plan-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_se-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_be-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_be-1}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_ppa-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_ppa-1}
...
\hypertarget{estrutura-fuxedsica-das-unidades}{%
\chapter{Estrutura Física das
Unidades}\label{estrutura-fuxedsica-das-unidades}}

\hypertarget{cras--}{%
\section{CRAS -}\label{cras--}}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/CRAS-acessibilidade-1}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/CRAS-acessibilidade-situacao-1}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/CRAS-internet-percentual-1}

\hypertarget{creas--}{%
\section{CREAS -}\label{creas--}}

\includegraphics{Censo-SUAS-2022_files/figure-latex/creas-situacao-1}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/creas-acessibilidade-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/CREAS-acessibilidade-situacao-1}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/CREAS-internet-percentual-1}

\hypertarget{centro-pop}{%
\section{Centro Pop}\label{centro-pop}}
...
\hypertarget{centro-dia-1}{%
\section{Centro Dia}\label{centro-dia-1}}

\hypertarget{cadastro-uxfanico-1}{%
\section{Cadastro Único}\label{cadastro-uxfanico-1}}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/postcad-acessibilidade-1}
...
\includegraphics{Censo-SUAS-2022_files/figure-latex/postcad-acessibilidade-situacao-1}

Em relação a computadores com acesso a internet, é indicador bem
presente

\includegraphics{Censo-SUAS-2022_files/figure-latex/postcad-internet-percentual-1}

\hypertarget{indicadores-do-suas}{%
\chapter{Indicadores do SUAS}\label{indicadores-do-suas}}

\hypertarget{id-cras---induxedce-de-desenvolvimento-do-cras}{%
\section{ID CRAS - Indíce de Desenvolvimento do
CRAS}\label{id-cras---induxedce-de-desenvolvimento-do-cras}}

\includegraphics{Censo-SUAS-2022_files/figure-latex/ID-CRAS-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/ID-CRAS-nivel-1}

\hypertarget{id-creas--induxedce-de-desenvolvimento-do-creas}{%
\section{ID CREAS -Indíce de Desenvolvimento do
CREAS}\label{id-creas--induxedce-de-desenvolvimento-do-creas}}

\includegraphics{Censo-SUAS-2022_files/figure-latex/ID-CREAS-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/ID-CREAS-nivel-1}

\hypertarget{id-conselho---induxedce-de-desenvolvimento-dos-conselhos-municipais-de-assistuxeancia-social}{%
\section{ID CONSELHO - Indíce de Desenvolvimento dos Conselhos
Municipais de Assistência
Social}\label{id-conselho---induxedce-de-desenvolvimento-dos-conselhos-municipais-de-assistuxeancia-social}}

\includegraphics{Censo-SUAS-2022_files/figure-latex/ID-conselho-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/ID-conselho-nivel-1}

Estrutura Administrativa dos conselhos municipais piorou, sobretudo após
2016.

\includegraphics{Censo-SUAS-2022_files/figure-latex/id-conselho-estrutura-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/id-conselho-dinamica-1}

\includegraphics{Censo-SUAS-2022_files/figure-latex/id-conselho-composicao-1}
