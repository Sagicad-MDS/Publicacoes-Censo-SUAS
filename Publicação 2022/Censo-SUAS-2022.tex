...
\item
  \textbf{Equipamentos, Serviços e Benefícios da Assistência Social:}
...
Conforme a \Cref{fig:estados-caracteristica-secretaria}, 25 estados
(96,4\%) a Secretaria estadual estava associada a uma ou mais políticas
setoriais, sendo predominante os grupos de duas e três politicas
setoriais .

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados-caracteristica-secretaria-2022-1} \caption[Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2022]{Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2022}\label{fig:estados-caracteristica-secretaria-2022}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados-caracteristica-secretaria-2012-1} \caption[Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2022]{Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2022}\label{fig:estados-caracteristica-secretaria-2012}\floatfoot{Fonte: MDS, Censo SUAS, eval=FALSE}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/secretarias-municipais-exclusivas-1} \caption[Percentual de Secretarias Municipais exclusivas de Assistência Social, segundo grandes regiões – Brasil, 2012 - 2017 e 2022]{Percentual de Secretarias Municipais exclusivas de Assistência Social, segundo grandes regiões – Brasil, 2012 - 2017 e 2022}\label{fig:secretarias-municipais-exclusivas}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
4 areas que não possuem 100\% contituídas (formal e informal) são elas:
Gestão do SUAS, Gestão do trabalho, Serviços e Beneficios e Regulação do
SUAS. Esta última apesenta menor percentual de formalização, sendo
38,5\% subdivisões constituídas formalmente conforme
...
presentes nas seguintes regiões do Brasil: 4 - Nordeste, 3 - Norte, 3 -
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados-atualizacao-lei-1} \caption[Percentual de estados segundo ano de atualização da Lei Estadual de regulamentação do Sistema Único de Assistência Social (SUAS) - Brasil, 2022]{Percentual de estados segundo ano de atualização da Lei Estadual de regulamentação do Sistema Único de Assistência Social (SUAS) - Brasil, 2022}\label{fig:estados-atualizacao-lei}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/PEAS-1} \caption[Percentual de Estados que não atualizaram Plano Estadual de Assistência Social em 2022 - Brasil]{Percentual de Estados que não atualizaram Plano Estadual de Assistência Social em 2022 - Brasil}\label{fig:PEAS}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/plan_apoio_tec-1} \caption[Percentual de Estados que possuiem Plano de Apoio Técnico pactuado na CIB - Brasil, 2013 - 2017 - 2022]{Percentual de Estados que possuiem Plano de Apoio Técnico pactuado na CIB - Brasil, 2013 - 2017 - 2022}\label{fig:plan_apoio_tec}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/munic_vit_estadual-1} \caption[Percentual de Municpioios que informam receber visitas de Apoio Técnico do Estado - Brasil, 2022]{Percentual de Municpioios que informam receber visitas de Apoio Técnico do Estado - Brasil, 2022}\label{fig:munic_vit_estadual}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados-cofinanciamento-municipios-1} \caption[Percentual de estados segundo realização de cofinanciamento aos municípios - Brasil]{Percentual de estados segundo realização de cofinanciamento aos municípios - Brasil; 2012, 2017 e 2022}\label{fig:estados-cofinanciamento-municipios}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
últimos 10 anos, sinaliza que i número de estados que cofinanciam os
...
Eventuais. No que se rere aos últimos 5 anos houve uma redução na
...
para o cofinanciamento da assistência social: 60,4\% fundo-a-fundo,
4,5\% via convênio e 7,8\% por convênio e fundo-a-fundo.
...
regiões Sul e Sudeste esses valores eram 80,1\% e 97,8\%,
respectivamente. Em todas as regiões, o recebimento de recursos
estaduais era majoritariamente fundo-a-fundo
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/munic_ord_despesa-1} \caption[Percentual de municípios quanto a ordenação de despesa do fundo estadual - Brasil, 2022]{Percentual de municípios quanto a ordenação de despesa do fundo estadual - Brasil, 2022}\label{fig:munic_ord_despesa}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/NUEP-1} \caption[Percentual de Estados que possuem Núcleo de Educação Permanete, 2022]{Percentual de Estados que possuem Núcleo de Educação Permanete, 2022}\label{fig:NUEP}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/municipios-possuem-plano-1} \caption[Percentual de municípios que possuem Plano de Capacitação e Educação Permanente, segundo grandes regiões - Brasil]{Percentual de municípios que possuem Plano de Capacitação e Educação Permanente, segundo grandes regiões - Brasil; 2015, 2017 e 2022}\label{fig:municipios-possuem-plano}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

Em relação a concurso público,

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/conc_munic-1} \caption[Percentual de municípios que realizaram concursos para trabalahdores nível superior ou médio do SUAS - Brasil, 2020 - 2021 - 2022]{Percentual de municípios que realizaram concursos para trabalahdores nível superior ou médio do SUAS - Brasil, 2020 - 2021 - 2022}\label{fig:conc_munic}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/conc_estado-1} \caption[Percentual de estados que realizaram concursos para trabalhadores nível superior do SUAS - Brasil, 2020 - 2021 - 2022]{Percentual de estados que realizaram concursos para trabalhadores nível superior do SUAS - Brasil, 2020 - 2021 - 2022}\label{fig:conc_estado}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}

\hypertarget{cadastro-uxfanico-para-programas-sociais}{%
\section{Cadastro Único para Programas
Sociais}\label{cadastro-uxfanico-para-programas-sociais}}

O Cadastro Único para Programas Sociais do Governo Federal estabelecido
através do art. 6º-F da Lei nº 8.742, de 7 de dezembro de 1993 (Lei
Orgânica de Assistência Social -- LOAS), tem a finalidade de coletar,
...
vulnerabilidade social, em particular as famílias de baixa de renda.

O objetivo é conhecer, incluir e aprimorar as políticas sociais. Assim,
esses dados subsidiam a realização de diagnósticos, ações de
planejamento, busca ativa, monitoramento e avaliação. Sua gestão é
interfederativa e descentralizada. Os locais de cadastramento são
efetuados pelos municípios no qual podem ser encontrados em unidades
exclusivas ou na rede de atendimento socioassistencial.

Dados do Censo SUAS 2022 destaca que xx\% (2.892) são unidades
exclusivas do Cadastro Único e xx estão em unidades da rede
socioassistencial
\footnote{os dados dos locais do Cadastro Único na rede socioassistencial CRAS, CREAS E CENTRO POP serão abordadas nos respectivos temas}.
...
Sobre as unidades exclusivas do Cadastro Único a sua maioria
\textbackslash footnote\{mais de 85\%\} se encontram na sede da
secretaria de Assistência Social ou em postos exclusivos. Os demais
percentuais são encontrados em outra unidade administrativa, em um
serviço integrado, OSC´s, conselho ou escola.

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/postcad-acessibilidade-1} \caption[Evolução percentual de postos do Cadastro Único segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil]{Evolução percentual de postos do Cadastro Único segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil; 2020, 2021 e 2022}\label{fig:postcad-acessibilidade}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/postcad-acessibilidade-situacao-1} \caption[Percentual de Postos do Cadastro Único com existência de condições de acessibilidade de acordo com a Norma da ABNT, segundo situação do imóvel – Brasil, 2022]{Percentual de Postos do Cadastro Único com existência de condições de acessibilidade de acordo com a Norma da ABNT, segundo situação do imóvel – Brasil, 2022}\label{fig:postcad-acessibilidade-situacao}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/postcad-internet-percentual-1} \caption[Evolução percentual de Cadastro Único com computadores com acesso à internet – Brasil]{Evolução percentual de Cadastro Único com computadores com acesso à internet – Brasil;  2020, 2021 e 2022}\label{fig:postcad-internet-percentual}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
Social Básica e à Gestão de Benefícios Assistenciais, presentes em
62,5\% e 63,1\% dos municípios, respectivamente. As que apresentavam
menores percentuais de formalização nos órgãos gestores municipais eram
as de Regulação do SUAS (36,5\%), de Proteção Social Especial (35,6\%),
de Vigilância Socioassistencial (31,1\%) e de Gestão do Trabalho
(30,6\%).
...
\hypertarget{unidades-serviuxe7os-e-benefuxedcios}{%
\chapter{Unidades, Serviços e
Benefícios}\label{unidades-serviuxe7os-e-benefuxedcios}}
...
dispõe deste equipamento público\textbackslash footnote\{77\% deles
localizados na Região Sul, 20\% na Região Sudeste e 3\% na região
Nordeste.\}. Assim, pode-se dizer que o desafio da expansão teve avanços
nestes últimos anos e deixa como nova demanda para reconstrução da
...
representa 87\% dos CRAS existentes neste mesmo período. No que se
refere a cobertura destes equipamentos sociais, estudos da Vigilancia
Nacional sinaliza uma descobertura no Brasil de 2.480 equipametnos de
CRAS. Estes dados são calculados com referencia ao número de famílias
referenciadas no
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/municipios-CRAS-1} \caption[Evolução do percentual de municípios com pelo menos um CRAS, segundo grandes regiões - Brasil, 2007 a 2017]{Evolução do percentual de municípios com pelo menos um CRAS, segundo grandes regiões - Brasil, 2007 a 2017}\label{fig:municipios-CRAS}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/CRAS-acessibilidade-1} \caption[Evolução percentual de CRAS segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil]{Evolução percentual de CRAS segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil; 2012, 2016 e 2022}\label{fig:CRAS-acessibilidade}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/CRAS-acessibilidade-situacao-1} \caption[Percentual de CRAS segundo condições de acessibilidade de acordo com a Norma da ABNT e por situação do imóvel – Brasil, 2022]{Percentual de CRAS segundo condições de acessibilidade de acordo com a Norma da ABNT e por situação do imóvel – Brasil, 2022}\label{fig:CRAS-acessibilidade-situacao}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
internet (\Cref{fig:CRAS-internet-quantitativo}), o que representa
95,1\% das unidades (\Cref{fig:CRAS-internet-percentual}).
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/CREAS-municipios-1} \caption[Evolução de CREAS por número de municípios, segundo grandes regiões - 2012, 2017 e 2022]{Evolução de CREAS por número de municípios, segundo grandes regiões - 2012, 2017 e 2022}\label{fig:CREAS-municipios}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/creas-regionais-1} \caption[Evolução de CREAS Regionais - por região]{Evolução de CREAS Regionais - por região}\label{fig:creas-regionais}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/creas-acessibilidade-1} \caption[Evolução percentual de CREAS segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil]{Evolução percentual de CREAS segundo condições de acessibilidade de acordo com a Norma da ABNT - Brasil; 2012, 2017 e 2022}\label{fig:creas-acessibilidade}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/CREAS-acessibilidade-situacao-1} \caption[Evolução percentual de CREAS segundo condições de acessibilidade de acordo com a Norma da ABNT e por situação do imóvel – Brasil, 2022]{Evolução percentual de CREAS segundo condições de acessibilidade de acordo com a Norma da ABNT e por situação do imóvel – Brasil, 2022}\label{fig:CREAS-acessibilidade-situacao}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
Além das condições de acessibilidades que foram anteriormente informadas
(acesso principal adaptado com rampas e rota acessível à Unidade, rotas
acessíveis aos espaços e banheiros, e banheiro adaptado para pessoas com
deficiência e/ou mobilidade reduzida), os outros tipos de adaptações
mais encontrados foram outras adaptações e tecnologias assistivas para
deficiência intelectual e autismo (observado em 393 unidades), seguido
do suporte de profissional com conhecimento em LIBRAS (com ocorrência em
380 unidades) (Gráfico 45). Gráfico 45: Quantidade de Centros Dia
segundo outras adaptações para acessibilidade -- Brasil, 2016 Fonte:
MDS, Censo SUAS.

Em 2016, existiam 851 Centros-Dia funcionando em imóveis próprios, 201
em imóveis alugados e 269 em imóveis cedidos. Entre os Centros-Dia que
funcionavam em imóveis próprios, 71,0\% (604 Unidades) tinham banheiro
adaptado para pessoas com deficiência e/ou mobilidade reduzida de acordo
com a Norma ABNT (NBR9050), enquanto entre os imóveis locados esse
percentual era de 36,8\% das 201 unidades. 65,4\% dos 269 imóveis
cedidos tinham essa adaptação em conformidade com a Norma ABNT. Para
todos os critérios analisados, os Centros-Dia que funcionavam em imóveis
próprios ou cedidos tinham melhores condições de adaptação que aqueles
que funcionavam em imóveis alugados (Gráfico 46). Gráfico 46: Percentual
de Centros Dia segundo condição de acessibilidade de acordo com a Norma
da ABNT e situação do imóvel -- Brasil, 2016 Fonte: MDS, Censo SUAS.

Em 2016, 82,5\% dos Centros-Dia (1.110 unidades) atenderam crianças e
adolescentes com deficiência e com algum grau de dependência. Esse
percentual foi inferior ao observado em 2015, quando 86,2\% dos
Centros-dia (1.155 unidades) prestaram atendimento a esse público. O
atendimento a idosos com algum grau de dependência (sem deficiência)
apresentou aumento, com 19,3\% das Unidades (259 unidades) declarando
ter atendido o público, frente a 16,9\% (227 unidades) em 2015 (Gráfico
47). Gráfico 47: Centros-Dia segundo público atendido. Brasil, 2015 e
2016 Fonte: MDS, Censo SUAS.
...
(54,9\%). Já no que se refere a outros benefícios, a região Sul foi a
que teve o maior percentual de CRAS que concederam, com 39,1\% das suas
1.517 unidades de CRAS (Gráfico 110). Gráfico 110 - Percentual de CRAS
por concessão de benefícios, segundo tipo de benefício e grandes regiões
- Brasil, 2016 Fonte: MDS, Censo SUAS.
...
\hypertarget{cadastro-uxfanico-para-programas-sociais-1}{%
\section{Cadastro Único para Programas
Sociais}\label{cadastro-uxfanico-para-programas-sociais-1}}
...
\hypertarget{participauxe7uxe3o-social-e-controle-social}{%
\chapter{Participação Social e Controle
Social}\label{participauxe7uxe3o-social-e-controle-social}}
...
237/2006
\footnote{https://www.mpba.mp.br/sites/default/files/biblioteca/crianca-e-adolescente/suas/resolucoes/resolucao_n_237_2006.pdf},
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_sede-1} \caption[Percentual de Conselhos municipais que possuem local/sede específico para funcionamento - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos municipais que possuem local/sede específico para funcionamento - Brasil, 2012 - 2017 - 2022}\label{fig:Cmas_sede}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_sede-1} \caption[Percentual de Conselhos Estaduais que possuem local/sede específico para funcionamento - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos Estaduais que possuem local/sede específico para funcionamento - Brasil, 2012 - 2017 - 2022}\label{fig:Ceas_sede}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_se-1} \caption[Percentual de Conselhos municipais com secretarias executivas - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos municipais com secretarias executivas - Brasil, 2012 - 2017 - 2022}\label{fig:Cmas_se}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_sec-1} \caption[Percentual de Conselhos Estaduais que possuem secretaria executiva - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos Estaduais que possuem secretaria executiva - Brasil, 2012 - 2017 - 2022}\label{fig:Ceas_sec}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Qtd_reuniao_cmas-1} \caption[Quantidade de reuniões realizadas nos conselhos municipais - Brasil, 2022]{Quantidade de reuniões realizadas nos conselhos municipais - Brasil, 2022}\label{fig:Qtd_reuniao_cmas}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

Fonte: MDS, Censo SUAS.

\textbf{6.2 -- Características dos Conselhos Municipais e Estaduais de
Assistência Social} \textbf{6.2.1 -- Secretaria Executiva} A Secretaria
...
\textbf{Gráfico xx - Distribuição percentual de Conselhos Estaduais e
Municipais segundo a existência de Secretaria Executiva -- Brasil, 2013
a 2017}

Fonte: MDS, Censo SUAS.

\textbf{6.2.2 -- IGD-SUAS} O Índice de Gestão Descentralizada do SUAS
...
Centro-Oeste (87,4\%). Foi observado aumento nos percentuais de
Conselhos Municipais que utilizam o IGD em todas as regiões, com exceção
da região Centro-Oeste, em que foi observada pequena queda de 1,2 pontos
percentuais entre 2015 e 2016 (Gráfico xx). \textbf{Gráfico xx -
Percentual de Conselhos Municipais de Assistência Social cujo IGD-SUAS
era destinado a custear despesas de funcionamento do Conselho, segundo
grandes regiões -- Brasil, 2014 a 2017}

Fonte: MDS, Censo SUAS.

\textbf{6.2.3 -- Plano de Assistência Social} A NOB SUAS 2012, em seu
Artigo 18, define o Plano de Assistência Social como um ``instrumento de
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_plan-1} \caption[Percentual de Conselhos Municipais que possuem e que deliberaram sobre o Plano de Assistência Social - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos Municipais que possuem e que deliberaram sobre o Plano de Assistência Social - Brasil, 2012 - 2017 - 2022}\label{fig:Cmas_plan}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_se-1} \caption[Percentual de Conselhos Estaduais que possuem e que deliberaram sobre o Plano de Assistência Social - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos Estaduais que possuem e que deliberaram sobre o Plano de Assistência Social - Brasil, 2012 - 2017 - 2022}\label{fig:Ceas_se}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Cmas_be-1} \caption[Percentual de Conselhos Municipais que deliberam sobre critérios de Benefícios Eventuais - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos Municipais que deliberam sobre critérios de Benefícios Eventuais - Brasil, 2012 - 2017 - 2022}\label{fig:Cmas_be}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/Ceas_be-1} \caption[Percentual de Conselhos Municipais que deliberam sobre critérios de Benefícios Eventuais - Brasil, 2012 - 2017 - 2022]{Percentual de Conselhos Municipais que deliberam sobre critérios de Benefícios Eventuais - Brasil, 2012 - 2017 - 2022}\label{fig:Ceas_be}
\end{figure}

\textbf{6.2.4 -- Regimento interno} O Regimento interno do conselho é um
...
entre 2009 e 2016, enquanto 510 (11,3\%) atualizaram seus regimentos
pela última vez entre 2005 e 2008. Observa-se que 1.139 Conselhos
Municipais (25,3\%) atualizaram seu regimento interno pela última vez
até o ano de 2004 (Gráfico xx). \textbf{Gráfico xx: Número de Conselhos
Municipais de Assistência Social por período de atualização do Regimento
Interno - Brasil, 2017}

Fonte: MDS, Censo SUAS.

\textbf{6.2.5 - Instância de controle social do Programa Bolsa Família
(PBF)} O Conselho é a instancia de controle social do Programa Bolsa
Família (PBF) e deve atuar no acompanhamento de todos os componentes do
...
controle social do Programa Bolsa Família (PBF), 85,2\% deliberaram
sobre os critérios de repasse de recursos para os municípios, 51,9\%
deliberaram sobre os critérios de repasse de recursos para entidades e
74,1\% deliberaram sobre proposta anual de orçamento do executivo.
Quanto aos Conselhos Municipais, 89,1\% eram instância de controle
social do PBF, 44,3\% deliberam sobre os critérios de repasse de
recursos para entidades e 67,4\% deliberaram sobre a proposta anual de
orçamento do executivo (Gráfico xx). Gráfico xx - Percentual de
Conselhos Municipais e Estaduais segundo suas atribuições -- Brasil,
2017

Fonte: MDS, Censo SUAS.

\textbf{6.2.6 -- Realização de atividades} Sobre a frequência de
realização de atividades pelos Conselhos Municipais, observa-se as mais
realizadas no ano de 2016 foram as visitas às unidades da rede
socioassistencial, que ocorreram semestralmente em 28,5\% dos Conselhos
Municipais, anualmente em 27,5\% e trimestralmente em 19,1\%. Também
figuram dentre as atividades mais realizadas as ações de mobilização
social e as reuniões ampliadas. 50,2\% dos Conselhos apontaram nunca
acompanhar votações e discussões do Poder Legislativo local e 73,5\%
nunca realizar reuniões descentralizadas (Gráfico xx).

\textbf{Gráfico xx - Distribuição percentual de Conselhos Municipais por
...
enquanto 29,6\% realizavam reuniões descentralizadas anualmente. Ações
de mobilização social não eram realizadas por 40,7\% dos conselhos,
enquanto 25,9\% nunca faziam visitas nas unidades de rede
socioassistencial. Todos os Conselhos Estaduais indicaram receber
denúncias em alguma periodicidade. Nenhum Conselho Estadual realizava
reuniões descentralizadas e reuniões ampliadas mensalmente ou
trimestralmente (Gráfico xx).

\textbf{Gráfico xx - Distribuição percentual de Conselhos Estaduais por
frequência com que realizam atividades -- Brasil, 2017}

Fonte: MDS, Censo SUAS.

\textbf{6.2.7 - Fiscalização} Em 2016, 36,4\% dos Conselhos Municipais
fiscalizavam as redes públicas e privadas, 53,6\% apenas a rede pública,
2,3\% apenas a rede privada e 7,7\% não fiscalizavam serviços,
programas, projetos e benefícios socioassistenciais do SUAS. O
percentual de Conselhos Municipais que não realizava fiscalização
aumentou em relação a 2015, enquanto o de Conselhos que fiscalizam tanto
a rede pública quanto a rede privada diminuiu no mesmo período (Gráfico
xx). \textbf{Gráfico xx - Percentual de Conselhos Municipais que
fiscalizaram serviços, programas, projetos e benefícios
socioassistenciais do SUAS -- Brasil, 2017}

Fonte: MDS, Censo SUAS.

Já a região Sul tinha o maior percentual de Conselhos Municipais que não
realizavam fiscalização de serviços, programas, projetos e benefícios
socioassistenciais do SUAS (11,3\%). Nas regiões Norte, Nordeste e
Centro-Oeste a maior parte dos Conselhos (68,7\%, 74,2\% e 55,7\%,
respectivamente) fiscalizava apenas a rede pública. Já nas regiões
Sudeste e Sul a maior parte dos Conselhos Municipais fiscalizava tanto a
rede pública quanto a rede privada (53\% e 45\% dos Conselhos,
respectivamente) (Gráfico xx). \textbf{Gráfico xx - Distribuição
percentual de Conselhos Municipais que fiscalizaram serviços, programas,
projetos e benefícios socioassistenciais do SUAS, segundo grandes
regiões - Brasil, 2017}

Fonte: MDS, Censo SUAS.

Quanto aos Conselhos Estaduais, 48,1\% fiscalizavam serviços, programas,
projetos e benefícios socioassistenciais tanto na rede pública quanto na
rede privada, o maior percentual desde 2013. No ano de 2016, 25,9\% dos
conselhos estaduais supervisionavam apenas a rede pública, 18,5\% não
fiscalizavam, e 7,4\% fiscalizavam apenas a rede privada (Gráfico xx).
\textbf{Gráfico xx: Percentual de Conselhos Estaduais que fiscalizaram
serviços, programas, projetos e benefícios socioassistenciais do SUAS --
Brasil, 2017}

Fonte: MDS, Censo SUAS.

Sobre a fiscalização e o acompanhamento do Programa Bolsa Família (PBF),
observa-se que o percentual de Conselho Municipais que executavam a
atividade vem aumentando desde 2012, atingindo 87,7\% em 2016. O
percentual de Conselhos Estaduais que fiscalizavam e acompanhavam o PBF
sofreu queda entre 2013 e 2015. Em 2016 foi observado aumento do
percentual em relação aos dois anos anteriores, e 77,8\% dos Conselhos
Estaduais declararam executar a atividade (Gráfico xx). \textbf{Gráfico
xx - Percentual de Conselhos Estaduais e Municipais que fiscalizam e
acompanham o Programa Bolsa Família -- Brasil, 2010 e 2017}

Fonte: MDS, Censo SUAS.

\textbf{6.2.8 -- Comissões Intergestores} A CIB e a CIT são espaços de
...
(Gráfico xx). \textbf{Gráfico xx - Percentual de Conselhos Estaduais e
Municipais que acompanhavam os processos de pactuação da CIB e CIT --
Brasil, 2010 a 2017}

Fonte: MDS, Censo SUAS.

\textbf{6.2.9 -- Publicação de deliberações e resoluções} Em 2016,
92,6\% dos Conselhos Estaduais publicaram todas as suas
deliberações/resoluções em diário oficial. Apenas 3,7\% (um estado)
tinha a maioria das decisões publicadas e 3,7\% a metade. Mais de 40\%
dos Conselhos Municipais não publicaram suas deliberações em Diário
Oficial, 12,7\% publicaram a minoria das deliberações, enquanto 32,5\%
publicaram todas as decisões em Diário Oficial (Gráfico xx).
\textbf{Gráfico xx - Publicação em Diário Oficial das
deliberações/resoluções dos Conselhos Municipais e Estaduais - Brasil,
2017}
...
36,4\% fiscalizavam ambas as redes, pública e privada. Por sua vez,
entre os Conselhos Estaduais 25,9\% fiscalizaram apenas a rede pública,
...
\url{https://aplicacoes.mds.gov.br/sagi/portal/index.php?grupo=105}.

\hypertarget{indicadores-do-suas}{%
\chapter{Indicadores do SUAS}\label{indicadores-do-suas}}

\emph{ID CRAS - Indíce de Desenvolvimento do CRAS}

\emph{ID CREAS -Indíce de Desenvolvimento do CREAS}

\emph{ID CONSELHO - Indíce de Desenvolvimento dos Conselhos Municipais
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/id-conselho-estrutura-1} \caption[Evolução do ID Conselho - Dimensão Estrutura Administrativa - 2014 - 2022]{Evolução do ID Conselho - Dimensão Estrutura Administrativa - 2014 - 2022}\label{fig:id-conselho-estrutura}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/id-conselho-dinamica-1} \caption[Evolução do ID Conselho - Dimensão dinâmica de Funcionamento - 2014 - 2022]{Evolução do ID Conselho - Dimensão dinâmica de Funcionamento - 2014 - 2022}\label{fig:id-conselho-dinamica}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}

\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/id-conselho-composicao-1} \caption[Evolução do ID Conselho - Composição do Conselho - 2014 - 2022]{Evolução do ID Conselho - Composição do Conselho - 2014 - 2022}\label{fig:id-conselho-composicao}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
\%\_\_\_\_\_\_\_\_\_\_\_\_\_\_ (2011) Lei Orgânica da Assistência Social
- LOAS. Brasília, DF: MDS. \%\_\_\_\_\_\_\_\_\_\_\_\_\_\_ (2010)
...
Municipais; CNAS; 2013. \%\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Orientações
gerais do Conselho Nacional de Assistência Social para a adequação da
Lei de criação dos Conselhos às normativas vigentes e ao exercício do
controle social no SUAS. \%\_\_\_\_\_\_\_\_\_\_\_\_\_\_Pacto de
Aprimoramento da Gestão Municipal do SUAS (Resoluções CIT n°18 de 15 de
julho de 2013). \%\_\_\_\_\_\_\_\_\_\_\_\_\_\_Pacto de Aprimoramento da
Gestão Estadual do (Resoluções CIT n°19 de 5 de dezembro de 2013)
\%\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Pacto de Aprimoramento SUAS, Resolução
CIT nº 32 de 31 de outubro de 2013 (revisão das prioridades e metas
específicas para a gestão estadual e do Distrito Federal e os
compromissos do governo federal). \%\_\_\_\_\_\_\_\_\_\_\_\_\_\_
Política Nacional de Educação Permanente do SUAS/ Ministério do
Desenvolvimento Social e Combate à Fome -- 1ª ed.~-- Brasília: MDS,
2013, 57p. \%\_\_\_\_\_\_\_\_\_\_\_\_\_\_Resolução nº 237, de 14 de
dezembro de 2006 (Diretrizes para a estruturação, reformulação e
funcionamento dos Conselhos de Assistência Social).
\%\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Tribunal de Contas da União. Controle
exercido por conselhos da assistência social: módulo 1: assistência
social no Brasil: políticas, recursos e controle / Tribunal de Contas da
União. -- Brasília: TCU, Secretaria de Controle Externo da Previdência,
do Trabalho e da Assistência Social, 2013.
\%\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Tribunal de Contas da União Orientações
para Conselheiros da Área de Assistência Social / Tribunal de Contas da
União. -- Brasília: TCU, 4ª Secretaria de Controle Externo, 2007.
\%MERIGO, J. A implantação dos serviços socioassistenciais na região da
associação de municípios da grande Florianópolis/SC: desafios e
perspectivas!. Brasília, 2010. Disponível em: \textless{}\url{http://}
\url{http://www.egem.org.br/arquivosbd/basico/0.535273001296661379_a_tipificacao_dos_servicos_socioassistenciais_na_regiao_da_granfpolis.pdf}
\textgreater. Acesso em: 20 mar. 2015. \%MORETTO, S. e D. SILVEIRA
(2010) A contribuição dos Conselhos de assistência social na
materialização do Sistema Único de Assistência Social (SUAS). UNISUL.
\%PIRES, Roberto Rocha C.(Org.) Efetividade das Instituições
Participativas no Brasil: estratégias de avaliação. Diálogos para o
desenvolvimento, Vol.7. \%ORIENTAÇÕES PARA ELABORAÇÃO DO PLANO
INDIVIDUAL DE ATENDIMENTO DE CRIANÇAS E ADOLESCENTES EM SERVIÇOS DE
ACOLHIMENTO, Brasília, abril de 2017. Ministério do Desenvolvimento
Social e Agrário - Secretaria Nacional de Assistência Social -
Departamento de Proteção Social Especial - Coordenação Geral de Serviços
de Acolhimento
