...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/estados_sec_exc-1} \caption[Percentual de Estados quanto a característica de estrutura administrativa, 2012 a 2022 - Brasil]{Percentual de Estados quanto a característica de estrutura administrativa, 2012 a 2022 - Brasil}\label{fig:estados_sec_exc}\floatfoot{Fonte: MDS, Censo SUAS}
\end{figure}
...
gestão do Cadastro Único e Bolsa Família. Esta informação é referente as
...
De acordo com os dados do \cref{fig:CREAS-porte} no qual sinaliza o
número de CREAS por município, levando-se em conta o porte populacional,
verifica-se que 54\% dos municípios não possuem CREAS. E eles estão
concentrados nos municípios de Pequeno Porte I e II respectivamente com
...
A presença de acesso principal adaptado com rota acessível aos espaços
...
O \cref{fig:creas-acessibilidade} referencia outras adaptações como com
rampas, rota acessível e calçada e de rota acessível ao banheiro. Todas
essas adaquações ampliaram a acessibildiade ao longo dos anos.
...
\begin{figure}
\includegraphics{Censo-SUAS-2022_files/figure-latex/CREAS-internet-percentual-1} \caption[Evolução percentual de CREAS com computadores com acesso à internet – Brasil, 2012, 2017 e 2022]{Evolução percentual de CREAS com computadores com acesso à internet – Brasil, 2012, 2017 e 2022}\label{fig:CREAS-internet-percentual}\floatfoot{Fonte: MDS, Censo SUAS.}
\end{figure}
...
socioassistencial especializada. Está prevista na Resolução 31/2013 do
CNAS. Essa composição é organizada através dos entes estaduais e o
\cref{fig:creas-regionais} sinaliza a evolução dessa oferta.
...
situação do imóvel. No geral todo as adaptações de acessibildiade são
...
Em relação a acessibilidade dos Centro Pop o
\cref{fig:cpop-acessibilidade-situacao} relaciona esta adaptação com a
situação do imóvel. No geral todo as adaptações de acessibilidade são
superiores ao serem relacionadas com os imóveis alugados. Em relação aos
imóveis cedidos, a adaptação de banheiro se sobressai em relação as
demais situações dos imóveis.
...
unidades com acesso à internet e a região Norte com maior desafio de
acesso, com 75\% das unidades de Centro Pop com acesso à internet.
...
sinaliza a frequência histórica de unidades referenciadas pelas
...
adaptação mais presente nestas unidades chegando nos registros do Censo
...
famílias. O \cref{fig:cdia-acessibilidade} sinaliza os locais e
...
Além disto, há outras adaptações importantes netsas undiades, dentre
elas as tecnologias assistidas, suportes com materiais em braille,
profissionais com conhecimento em libras entre outros destacados no
gráfico abaixo:
