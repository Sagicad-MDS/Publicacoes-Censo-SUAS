...
porte <- as.character(factor_porte)
```
...
```{r}
  ...
  porte <- sprintf("em município de porte %s", porte)
```
...
cat("Para alcançar o **nível 3** na dimensão ", dimensao, ", o ", equipamento, " ", porte, " precisa:", sep="")
```
```{asis, echo=(n_unidades>0 && menor_nivel<3 && maior_nivel>1)}
...
cat("Para alcançar o **nível 4** na dimensão ", dimensao, ", o ", equipamento, " ", porte, " precisa:", sep="")
```
```{asis, echo=(n_unidades>0 && menor_nivel<4 && maior_nivel>2)}
...
cat("Para alcançar o **nível 5** na dimensão ", dimensao, ", o ", equipamento, " ", porte, " precisa:", sep="")
```
...
A \Cref{fig:ID-CREAS} mostra a evolução das médias do ID CREAS ao longo dos anos no município de `r nome_municipio`, `r uf_municipio`.
