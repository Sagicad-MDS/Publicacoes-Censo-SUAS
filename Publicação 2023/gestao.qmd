...
```{r fig-capac_cad, fig.cap = "Ações de capacitação sobre Cadastro Único realziadas pelo município - Brasil, 2021 e 2023", fig.footer = "Fonte: MDS, Censo SUAS.", eval=FALSE}
