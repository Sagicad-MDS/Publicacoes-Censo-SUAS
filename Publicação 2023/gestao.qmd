...
[^gestao-6]: O formulário do Censo SUAS sobre os postos do Cadastro Único foi introduzido em 2020, por isso as informações no Censo SUAS sobre estes equipamentos estão dispníveis a partir desta data.
