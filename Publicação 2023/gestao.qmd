...
Em relação à incorporação de outras políticas setoriais na pasta da Assistência Social, os dados de 2023 indicam que a maioria das secretarias estaduais integra de duas a três políticas setoriais adicionais confore pode ser observado através @fig-estados-caracteristica-secretaria-2023.
...
```{r fig-estados-caracteristica-secretaria-2023, fig.cap = "Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r fig-estados-caracteristica-secretaria-2013, fig.cap = "Percentual de Secretarias Estaduais de acordo com composição administrativa relacionada a outras políticas - Brasil, 2013", fig.footer = "Fonte: MDS, Censo SUAS", eval=FALSE}
...
No que se refere aos municípios e a estrutura administrativa da Assistência Social, esse cenário nacional se configurou inverso ao das gestões Estaduais. Observa-se através do @fig-sec-munic-exc um aumento de 217 municípios (1,5 pontos percentuais) com secretarias exclusivas de Assistência Social do período de 2012 a 2019[^gestao-5].
...
```{r fig-secretarias-municipais-exclusivas, fig.cap = "Percentual de Secretarias Municipais exclusivas de Assistência Social, segundo grandes regiões – Brasil, 2012 - 2017 e 2019", fig.footer = "Fonte: MDS, Censo SUAS.",eval=FALSE}
...
#  bind_rows(f_selecao_regiao_ano(gm_2023, q1, "Secretaria municipal exclusiva da área de Assistência Social", Região, "2019")) %>%
...
```{r fig-uf_subd-formal, fig.cap = "Percentual de estados segundo subdivisões administrativas constituídas na estrutura formal do órgão gestor - Brasil; 2012, 2018 e 2023", fig.footer = "Fonte: MDS, Censo SUAS.", eval=FALSE}
...
```{r fig-uf_subd, fig.cap = "Percentual de estados segundo constituição de subdivisões administrativas na estrutura do órgão gestor - Brasil; 2012, 2018 e 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 8
...
#ver com a Shirley se continua o dado de 2012 ou atualiza para outro ano tendo em vista a diferença no censo suas 2013
...
```{r fig-estados-constituicao-subdivisoes, fig.cap = "Percentual de estados segundo característica da estrutura administrativa da Secretaria Estadual de Assistência Social - Brasil,  2022", fig.footer = "Fonte: MDS, Censo SUAS.",eval=FALSE}
...
```{r fig-estados-constituicao-subdivisoes, fig.cap = "Percentual de estados segundo característica da estrutura administrativa da Secretaria Estadual de Assistência Social - Brasil,  2023", fig.footer = "Fonte: MDS, Censo SUAS.", fig.height = 7}
...
# Questionário 2023:
  select(
    ...
    "Gestão do Cadastro Único e Programa Bolsa Família"=q3_8,
    "Gestão de Benefícios Assistenciais (BPC, Benefícios Eventuais)"=q3_9) %>%
   # "Programa Criança Feliz"=q3_10) %>% 2023 não existe
...
```{r fig-munic_sub, fig.cap = "Percentual segundo estrutura administrativa formal da Secretaria Municipal de Assistência Social - Brasil, 2012 - 2018 - 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 5
...
```{r fig-municipais-constituicao-subdivisoes, fig.cap = "Distribuição dos órgãos gestores municipais segundo constituição/formalização de subdivisões administrativas - Brasil, 2022", fig.footer = "Fonte: MDS, Censo SUAS";eval=FALSE}
#| fig-height: 5
...
```{r fig-municipais-constituicao-subdivisoes, fig.cap = "Distribuição dos órgãos gestores municipais segundo constituição/formalização de subdivisões administrativas - Brasil, 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
#| fig-height: 5
...
```{r fig-plan_apoio_tec, fig.cap = "Percentual de Estados que possuem Plano de Apoio Técnico pactuado na CIB - Brasil, 2013 a 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
```{r fig-estados-formas-apoio, fig.cap = "Percentual de estados segundo formas de apoio técnico aos municípios - Brasil, 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r fig-NUEP, fig.cap = "Percentual de Estados que possuem Núcleo de Educação Permanente, 2020 a 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
grafico <- ge_cofinanciamento(ge_2012, q64_0, "2012", codigo_ibge) %>%
  ...
  (ge_cofinanciamento(feas_2018, q_6, "2018", IBGE)) %>%
...
```{r fig-estados-blocos-recursos, fig.cap = "Número de estados segundo a destinação dos recursos transferidos aos municípios por blocos de financiamento - Brasil; 2012, 2017 e 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r fig-estado_ord_despesa, fig.cap = "Percentual de estados quanto a ordenação de despesa do Fundo Estadual - Brasil, 2018-2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r fig-munic_ord_despesa, fig.cap = "Percentual de municípios quanto a ordenação de despesa do Fundo Municipal - Brasil, 2013 - 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r fig-be_uf_renda, fig.cap = "Percentual de estados que possuem programa próprio de transferência de renda, Brasil, 2012 - 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
| CREAS                 |    281    |    174    |    199    |    199    |    208    |    230    | 191       |
| Centro POP            |    112    |    83     |    84     |    108    |    106    |    115    | 131       |
| Postos Cadastro Único |    \-     |    \-     |    \-     |   2.530   |   2.695   |   2.892   | 3.037     |
...
```{r fig-capac_cad, fig.cap = "Ações de capacitação sobre Cadastro Único realizadas pelo município - Brasil, 2021 e 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#2020
  categoria <- case_when(!! cod_categoria == "1"~"ofertada pelo próprio gestor do Cadastro Único",
                         !! cod_categoria == "2"~"por servidores da equipe do Cadastro Único e/ou Assistencia Social",
                         !! cod_categoria == "3"~"Sim, por consultores externos",
                         !! cod_categoria == "4"~"por instituições de ensino",
                         !! cod_categoria == "5"~"Outros",
                         !! cod_categoria == "6"~"Não realiza")
...
```{r fig-BPC_cadunico, fig.cap = "Ações sobre BPC e acompanhamento e atualização e inclusão no Cadastro Único", fig.footer = "Fonte: MDS, Censo SUAS"}

grafico <-
  f_sim(gm_2023, q59_6, "2023") %>%
  #f_sim(gm_2022, q55_6, "2022") %>%
  #f_sim(gm_2021, q55_6, "2021") %>%
  #f_sim(gm_2020, q59_6, "2020") %>%
...
```{r fig-visit_dom, fig.cap = "Situações mais frequentes de entrevistas domiciliares no Cadastro Único - Brasil, 2020 a 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 5
