...
```{r fig-estados_sec_exc, fig.cap = "Percentual de Estados quanto à característica de estrutura administrativa - Brasil, 2012 a 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
```{r fig-capac_cad, fig.cap = "Ações de capacitação sobre Cadastro Único realziadas pelo município - Brasil, 2021 e 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
```{r fig-BPC_cadunico, fig.cap = "Ações sobre BPC e acompanhamentoatualziação e inclussão no Cadastro único", fig.footer = "Fonte: MDS, Censo SUAS"}
