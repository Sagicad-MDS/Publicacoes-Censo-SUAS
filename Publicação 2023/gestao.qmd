...
```{r fig-estados_sec_exc, fig.cap = "Percentual de Estados quanto a caracteristica de estrutura administrativa - Brasil, 2012 a 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
Quando se observa a regularização destas áreas, há um grupo instituídas informalmente conforme o @fig-estados-constituicao-subdivisoes, e setores que ainda não estão constituídos em 100% dos estados, a saber Gestão do SUAS, Gestão do trabalho e regulação do SUAS.
...
# Questionário 2023:
  select(
    ...
    "Gestão do Cadastro Único e Programa Bolsa Família"=q3_8,
    "Gestão de Benefícios Assistenciais (BPC, Benefícios Eventuais)"=q3_9,
   # "Programa Criança Feliz"=q3_10) %>% 2023 não exite
...
```{r fig-municipios-atualizacao-lei, fig.cap = "Percentual de municípios segundo último ano de atualização da Lei Municipal de regulamentação do Sistema Único de Assistência Social (SUAS) - Brasil, 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
grafico <- f_sim(gm_2015, q40, "2015") %>%
    ...
    bind_rows(f_sim(gm_2023, q62, "2022")) %>%
...
#  bind_rows(ge_cofinanciamento(feas_2023, q9, "2023", IBGE)) %>%
...
#  bind_rows(ge_destinacao_recursos(ge_2016, q34_5, "2016", "5")) %>%
 ...
 # bind_rows(ge_destinacao_recursos(feas_2023, q13_1, "2023", "1")) %>%
 # bind_rows(ge_destinacao_recursos(feas_2023, q13_2, "2023", "2")) %>%
 # bind_rows(ge_destinacao_recursos(feas_2023, q13_3, "2023", "3")) %>%
 # bind_rows(ge_destinacao_recursos(feas_2023, q13_4, "2023", "4")) %>%
 # bind_rows(ge_destinacao_recursos(feas_2023, q13_5, "2023", "5"))
    
#feas não está rodando
