...
grafico <- f_quantitativo_regiao_ano (cmun_2013, Região, "2013") %>%
...
#  bind_rows(f_quantitativo_regiao_ano(cmun_2022, IBGE, "2022")) %>%
   bind_rows(f_quantitativo_regiao_ano(cmun_2023, IBGE, "2023")) %>%
...
```{r fig-qtdceas_reuniao, fig.cap = "Proporção conselhos estaduais quanto a realização de reuniões plenárias no ano anterior";eval=FALSE}
...
```{r fig-qtdcmas_reuniao, fig.cap = "Proporção de Conselhos Municipais quanto a quantidade de realização de reuniões plenárias do Conselho (ordinárias e extraordinárias)";eval=FALSE}
...
#2018
 ...
 tabela <- usu_ceas(cest_2018,q_68_1,"2018","1") %>%
  ...
  bind_rows(usu_ceas(cest_2023,q65_1,"2023","1")) %>%
  bind_rows(usu_ceas(cest_2023,q65_2,"2023","2")) %>%
  bind_rows(usu_ceas(cest_2023,q65_3,"2023","3")) %>%
  bind_rows(usu_ceas(cest_2023,q65_4,"2023","4")) %>%
  bind_rows(usu_ceas(cest_2023,q65_5,"2023","5")) %>%
  bind_rows(usu_ceas(cest_2023,q65_6,"2023","6")) %>%
  bind_rows(usu_ceas(cest_2023,q65_99,"2023","7")) %>%
...
#2018
 ...
 tabela <-usu_cmun(cmun_2018,q_68_1,"2018","1") %>%
  ...
  bind_rows(usu_cmun(cmun_2023,q65_1,"2023","1")) %>%
  bind_rows(usu_cmun(cmun_2023,q65_2,"2023","2")) %>%
  bind_rows(usu_cmun(cmun_2023,q65_3,"2023","3")) %>%
  bind_rows(usu_cmun(cmun_2023,q65_4,"2023","4")) %>%
  bind_rows(usu_cmun(cmun_2023,q65_5,"2023","5")) %>%
  bind_rows(usu_cmun(cmun_2023,q65_6,"2023","6")) %>%
  bind_rows(usu_cmun(cmun_2023,q65_99,"2023","7")) %>%
...
#2020
 ...
 tabela <- trab_rep(cest_2018,q_69_1,"2018","1") %>%
  ...
  bind_rows(trab_rep(cest_2023,q66_1,"2023","1")) %>%
  bind_rows(trab_rep(cest_2023,q66_2,"2023","2")) %>%
  bind_rows(trab_rep(cest_2023,q66_3,"2023","3")) %>%
  bind_rows(trab_rep(cest_2023,q66_4,"2023","4")) %>%
  bind_rows(trab_rep(cest_2023,q66_99,"2023","5")) %>%
  bind_rows(trab_rep(cest_2023,q66_0,"2023","6")) %>%
...
#2018
 ...
 tabela <- trab_cmun(cmun_2018,q_69_1,"2018","1") %>%
  ...
  bind_rows(trab_cmun(cmun_2023,q66_1,"2023","1")) %>%
  bind_rows(trab_cmun(cmun_2023,q66_2,"2023","2")) %>%
  bind_rows(trab_cmun(cmun_2023,q66_3,"2023","3")) %>%
  bind_rows(trab_cmun(cmun_2023,q66_4,"2023","4")) %>%
  bind_rows(trab_cmun(cmun_2023,q66_99,"2023","5")) %>%
  bind_rows(trab_cmun(cmun_2023,q66_0,"2023","6")) %>%
