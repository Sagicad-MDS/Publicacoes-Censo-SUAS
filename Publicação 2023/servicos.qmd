...
O PAIF compõe um conjunto de ações conjugada àsseguranças sociais referenciadas a unidades de CRAS. De acordo com Tipificação Nacional dos Serviços Socioassistenciais, o PAIF "consiste no trabalho social com família, de caráter continuado, com a finalidade de fortalecer a função protetiva das famílias, prevenir a ruptura dos seus vínculos, promover seu acesso e usufruto do direito" [^servicos-2].
...
```{r fig-CRAS-SCFV, fig.cap = "Percentual de CRAS que executavam diretamente os Serviços de Convivência e Fortalecimento de Vínculos - Brasil, 2014 a 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
grafico <- f_sim(cras_2012, q19_1a, "2012") %>%
  ...
  bind_rows(f_sim(cras_2022, q17, "2023")) %>%
...
Os Serviços de Proteção Social Básica no Domicílio para Pessoas Idosas e com Deficiência estão previstos na Tipificação dos Serviços Socioassistenciais. Recentemente a Resolução CNAS nº 117/2023 atualizou a tipificação, incluindo crianças e gestantes como público alvo da modalidade destes serviços.[^servicos-3]. Os dados do @fig-CRAS-PSB mostram um aumento de 3 pontos percentuais no período de 2018 a 2022.[^servicos-4]. Atualmente 73% das unidades informam possuir a oferta desses serviços.

[^servicos-3]: RESOLUÇÃO CNAS/MDS Nº 117, DE 28 DE AGOSTO DE 2023

[^servicos-4]: essa pergunta surge a partir de 2018

```{r fig-CRAS-PSB, fig.cap = "Percentual de CRAS que executavam diretamente os Serviços de Proteção Social Básica nos domicílios - Brasil, 2014 a 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
grafico <- f_sim(cras_2018, q_24, "2018") %>%
  ...
  bind_rows(f_sim(cras_2022, q24, "2023")) %>%
...
O @fig-paefi_creas mostra que os principais atendimentos, no período de 2019 a 2022, são os seguintes: abuso e violência sexual, violência contra mulher, crianças e adolescentes, situações de negligência e abandono.

```{r fig-paefi_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações de riscos em decorrência de situações e ciclos de vida - Brasil  2023"}
#| fig-height: 4.5
...
tabela <- 
  paefi_creas (creas_2023,q12_1_1,"2023","1") %>%
 bind_rows(paefi_creas(creas_2023,q12_1_2,"2023","2")) %>%
 bind_rows(paefi_creas(creas_2023,q12_1_4,"2023","3")) %>%
 bind_rows(paefi_creas(creas_2023,q12_3_1,"2023","4")) %>%
 bind_rows(paefi_creas(creas_2023,q12_5_4,"2023","5")) %>%
 bind_rows(paefi_creas(creas_2023,q12_13_1,"2023","6")) %>%
 bind_rows(paefi_creas(creas_2023,q12_13_2,"2023","7")) %>%
 bind_rows(paefi_creas(creas_2023,q12_13_3,"2023","0")) %>% 
  
# paefi_creas (creas_2022,q16_1_1,"2022","1") %>%
# bind_rows(paefi_creas(creas_2022,q16_1_2,"2022","2")) %>%
# bind_rows(paefi_creas(creas_2022,q16_1_4,"2022","3")) %>%
# bind_rows(paefi_creas(creas_2022,q16_5_1,"2022","4")) %>%
# bind_rows(paefi_creas(creas_2022,q16_9_2,"2022","5")) %>%
# bind_rows(paefi_creas(creas_2022,q16_13_1,"2022","6")) %>%
# bind_rows(paefi_creas(creas_2022,q16_13_2,"2022","7")) %>%
# bind_rows(paefi_creas(creas_2022,q16_13_3,"2022","0")) %>% 
...
#2022 revisar
 ...
 tabela <- 
   paefi2_creas(creas_2023,q12_7_1,"2023","1") %>%
  bind_rows(paefi2_creas(creas_2023,q12_7_2,"2023","2")) %>%
  bind_rows(paefi2_creas(creas_2023,q12_7_3,"2023","3")) %>%
  bind_rows(paefi2_creas(creas_2023,q12_7_4,"2023","4")) %>%
  bind_rows(paefi2_creas(creas_2023,q12_8_1,"2023","6")) %>%
   
  bind_rows(paefi2_creas(creas_2022,q16_8_1,"2022","1")) %>% 
...
```{r fig-paefi6_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS - Pessoas em situação de imigração / refúgio - Brasil  2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#2022
 ...
 tabela <-
    paefi6_creas (creas_2023,q12_15_1,"2023","1") %>%
  bind_rows(paefi6_creas(creas_2023,q12_15_2,"2023","2")) %>%
  bind_rows(paefi6_creas(creas_2023,q12_15_3,"2023","3")) %>%
  bind_rows(paefi6_creas(creas_2023,q12_15_4,"2023","4")) %>%
  bind_rows(paefi6_creas(creas_2023,q12_15_0,"2023","5")) %>%
   
  bind_rows(paefi6_creas(creas_2022,q16_14_1,"2022","1")) %>% 
...
```{r fig-creas-tradicionais, fig.cap = "Percentual de CREAS que atendem povos e comunidades tradicionais -  por grupos , Região - 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 8

grafico <- 
  f_selecao_regiao_ano (creas_2023, q42_1, "Sim", Regiao, "Povos Indígenas") %>%
    bind_rows(f_selecao_regiao_ano(creas_2023, q42_2, "Sim", Regiao, "Comunidade Quilombola")) %>%
    bind_rows(f_selecao_regiao_ano(creas_2023, q42_4, "Sim", Regiao, "Comunidade Ribeirinha")) %>%
    bind_rows(f_selecao_regiao_ano(creas_2023, q42_5, "Sim", Regiao, "Povos de Matriz Africana e de terreiro")) %>%
    bind_rows(f_selecao_regiao_ano(creas_2023, q42_6, "Sim", Regiao, "Comunidades Extrativistas")) %>%
    bind_rows(f_selecao_regiao_ano(creas_2023, q42_99, "Sim", Regiao, "Outros povos e comunidades tradicionais")) %>%
...
```{r fig-creas-pse-domicilio, fig.cap = "Percentual de CREAS que realizam Serviço de Proteção Social Especial para Pessoas com Deficiência, Idosas e suas Famílias, 2018 a 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 4.5
...
tabela <- creas_pse(creas_2018,q35,"2018") %>%
  ...
  bind_rows(creas_pse(creas_2022, q38, "2023")) %>%
...
```{r fig-CREAS-abordagem-social, fig.cap = "Quantidade de CREAS que realizam o Serviço Especializado em Abordagem Social, Brasil, 2018 - 2020 e 2023", fig.footer = "Fonte: MDS, Censo SUAS"}
...
grafico <- creas_psee(creas_2018, q35, "2018") %>%
  ...
  bind_rows(creas_psee(creas_2023, q30, "2023")) %>%
...
```{r fig-fam_acolhedora, fig.cap = "Percentual de municípios com Serviços de Família Acolhedora - Brasil, 2017 a 2023", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 6.5
...
grafico <- f_quantitativo_regiao_ano(famacolfam_2017, IBGE, "2017") %>%
   ...
   bind_rows(f_quantitativo_regiao_ano(famacolfam_2022, IBGE7, "2022")) %>%
   bind_rows(f_quantitativo_regiao_ano(famacolfam_2023, IBGE, "2023")) %>%
...
```{r fig-be-munic, fig.cap = "Percentual de municípios que concedem Benefícios Eventuais - Brasil, 2023", fig.footer = "Fonte: MDS, Censo SUAS."}

tabela<-gm_2023 %>%
# Questionário 2022:
  select("Situação de Morte"=q60_1,
         "Situação de Natalidade"=q60_2,
         "Situação de Calamidade Pública"=q60_3,
         "Situação de Vulnerabilidade Temporária"=q60_4) %>%
#-------------------
  gather("Categoria","Nível") %>%
...
```{r fig-be-local, fig.cap = "Percentual de local onde os benefícios eventuais são concedidos nos municípios - 2023", fig.footer = "Fonte: MDS, Censo SUAS."}

grafico <- gm_2023 %>%
# Questionário 2022:
  select("Situação de Morte"=q60_1_1,
         "Situação de Natalidade"=q60_2_1,
         "Situação de Calamidade Pública"=q60_3_1,
         "Situação de Vulnerabildiade Temporária"=q60_4_1) %>%
