...
tabela <- 
  paefi_creas (creas_2023,q16_1_1,"2023","1") %>%
  bind_rows(paefi_creas(creas_2023,q16_1_2,"2023","2")) %>%
  bind_rows(paefi_creas(creas_2023,q16_1_4,"2023","3")) %>%
  bind_rows(paefi_creas(creas_2023,q16_3_1,"2023","4")) %>%
  bind_rows(paefi_creas(creas_2023,q16_5_4,"2023","5")) %>%
  bind_rows(paefi_creas(creas_2023,q16_7_1,"2023","6")) %>%
  bind_rows(paefi_creas(creas_2023,q16_7_2,"2023","7")) %>%
  bind_rows(paefi_creas(creas_2023,q16_7_3,"2023","0")) %>% 
...
```{r fig-paefi2_creas, fig.cap = "Atendimentos realizados pelo PAEFI/CREAS por situações de riscos em decorrência trabalho análogo a escravidão e trabalho infantil - Brasil  2023", fig.footer = "Fonte: MDS, Censo SUAS."}
...
#2022
 ...
 tabela <- 
   paefi2_creas(creas_2023,q16_8_1,"2023","1") %>%
  bind_rows(paefi2_creas(creas_2023,q16_8_2,"2023","2")) %>%
  bind_rows(paefi2_creas(creas_2023,q16_8_3,"2023","3")) %>%
  bind_rows(paefi2_creas(creas_2023,q16_8_4,"2023","4")) %>%
  bind_rows(paefi2_creas(creas_2023,q16_9_1,"2023","6")) %>%
   
   paefi2_creas(creas_2022,q16_8_1,"2022","1") %>%
...
```{r fig-CREAS-abordagem-social, fig.cap = "Quantidade de CREAS que realizam o Serviço Especializado em Abordagem Social, Brasil, 2018 - 2020 e 2022", fig.footer = "Fonte: MDS, Censo SUAS"}
...
```{r fig-fam_acolhedora, fig.cap = "Percentual de municípios com Serviços de Família Acolhedora - Brasil, 2017 a 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 6.5
...
```{r fig-be-munic, fig.cap = "Percentual de municípios que concedem Benefícios Eventuais - Brasil, 2022", fig.footer = "Fonte: MDS, Censo SUAS."}
