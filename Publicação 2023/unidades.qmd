...
#  bind_rows(f_maior0_regiao_ano(cras_2018, q_11_2, IBGE, "2018")) %>%
...
grafico <- 
  f_maior0_regiao_ano(creas_2012, q14, Região, "2012") %>%
...
grafico <-
  ...
  bind_rows(f_selecao_regiao_ano(creas_2013, q1, "Regional", Região, "2013")) %>%
  ...
  bind_rows(f_selecao_regiao_ano(creas_2019, q1, "Regional", IBGE, "2019")) %>%
 # bind_rows(f_selecao_regiao_ano(creas_2020, q1, "Regional", Regiao, "2020")) %>%
  bind_rows(f_selecao_regiao_ano(creas_2021, q1, "Regional", IBGE, "2021")) %>%
...
grafico <- 
  f_maior0_regiao_ano(cpop_2012, q14_2, Região, "2012") %>%
